...
class Span:
    ...
    def set_meta(self, k: Union[builtins.str, builtins.bytes], v: Union[builtins.int, builtins.float]) -> None: ...
    def set_metas(self, kvs: builtins.dict[Union[builtins.str, builtins.bytes], builtins.str]) -> None: ...
    def set_metric(self, key: Union[builtins.str, builtins.bytes], value: Union[builtins.int, builtins.float]) -> None: ...
    def set_metrics(self, metrics: builtins.dict[Union[builtins.str, builtins.bytes], Union[builtins.int, builtins.float]]) -> None: ...
    def get_metric(self, key: Union[builtins.str, builtins.bytes]) -> Optional[NumericType]: ...
