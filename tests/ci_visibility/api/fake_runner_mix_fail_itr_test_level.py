...
def main():
    ...
    api.CISession.discover("manual_test_mix_fail_itr_test_level", "dd_manual_test_fw", "1.0.0")
    api.CISession.start()
    ...
    api.CITest.mark_itr_unskippable(suite_6_test_2_id)
    ...
    api.CITest.mark_itr_forced_run(suite_6_test_2_id)
