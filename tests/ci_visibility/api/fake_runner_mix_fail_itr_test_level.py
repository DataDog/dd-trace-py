...
def main():
    ...
    api.TestSession.discover("manual_test_mix_fail_itr_test_level", "dd_manual_test_fw", "1.0.0")
    ...
    module_3_id = ddtrace.ext.test_visibility.item_ids.TestModuleId("module_3")
    suite_3_id = ddtrace.ext.test_visibility.item_ids.TestSuiteId(module_3_id, "suite_3")
    suite_4_id = ddtrace.ext.test_visibility.item_ids.TestSuiteId(module_3_id, "suite_4")

    suite_3_test_1_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_3_id, "test_1")
    suite_3_test_2_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_3_id, "test_2")
    suite_3_test_3_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_3_id, "test_3")

    suite_4_test_1_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_4_id, "test_1")
    suite_4_test_2_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_4_id, "test_2")
    suite_4_test_3_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_4_id, "test_3")
    ...
    module_4_id = ddtrace.ext.test_visibility.item_ids.TestModuleId("module_4")
    suite_5_id = ddtrace.ext.test_visibility.item_ids.TestSuiteId(module_4_id, "suite_5")
    suite_6_id = ddtrace.ext.test_visibility.item_ids.TestSuiteId(module_4_id, "suite_6")

    suite_5_test_1_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_5_id, "test_1")
    suite_5_test_2_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_5_id, "test_2")
    suite_5_test_3_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_5_id, "test_3")

    suite_6_test_1_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_6_id, "test_1")
    suite_6_test_2_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_6_id, "test_2")
    suite_6_test_3_id = ddtrace.ext.test_visibility.item_ids.TestId(suite_6_id, "test_3")

    api.TestModule.discover(module_4_id)

    api.TestSuite.discover(suite_5_id)

    api.Test.discover(suite_5_test_1_id, source_file_info=api.TestSourceFileInfo(Path("module_5/suite_5.py"), 4, 6))
    api.Test.discover(suite_5_test_2_id, source_file_info=api.TestSourceFileInfo(Path("module_5/suite_5.py"), 9, 12))
    api.Test.discover(suite_5_test_3_id, source_file_info=api.TestSourceFileInfo(Path("module_5/suite_5.py"), 16, 48))

    api.TestSuite.discover(suite_6_id)
    api.Test.discover(suite_6_test_1_id)
    api.Test.discover(suite_6_test_2_id)
    api.Test.mark_itr_unskippable(suite_6_test_2_id)
    api.Test.discover(suite_6_test_3_id)
    ...
    api.Test.add_coverage_data(suite_1_test_3_id, {suite_1_test_3_rel_path_1: CoverageLines.from_list([2])})
    ...
    api.TestModule.start(module_4_id)

    api.TestSuite.start(suite_5_id)

    #
    # suite_5_test_1 test
    api.Test.start(suite_5_test_1_id)
    api.Test.mark_itr_skipped(suite_5_test_1_id)
    #
    # suite_5_test_2 test
    api.Test.start(suite_5_test_2_id)
    api.Test.mark_itr_skipped(suite_5_test_2_id)
    #
    # suite_5_test_3 test
    api.Test.start(suite_5_test_3_id)
    api.Test.mark_itr_skipped(suite_5_test_3_id)

    api.TestSuite.mark_itr_skipped(suite_5_id)

    api.TestSuite.start(suite_6_id)

    #
    # suite_6_test_1 test
    api.Test.start(suite_6_test_1_id)
    api.Test.mark_itr_skipped(suite_6_test_1_id)
    #
    # suite_6_test_2 test
    api.Test.start(suite_6_test_2_id)
    api.Test.mark_itr_forced_run(suite_6_test_2_id)
    api.Test.mark_pass(suite_6_test_2_id)
    #
    # suite_6_test_3 test
    api.Test.start(suite_6_test_3_id)
    api.Test.mark_itr_skipped(suite_6_test_3_id)

    api.TestSuite.finish(suite_6_id)

    api.TestModule.finish(module_4_id)
