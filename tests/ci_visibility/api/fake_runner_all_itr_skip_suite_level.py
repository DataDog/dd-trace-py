...
def main():
    ...
    api.TestSession.discover("manual_test_all_itr_skip_suite_level", "dd_manual_test_fw", "1.0.0")
    ...
    api.TestSuite.mark_itr_skipped(suite_1_id)
    ...
    api.TestSuite.mark_itr_skipped(suite_2_id)
