...
def run_tests():
    ...
    while api.InternalTest.efd_should_retry(m1_s1_t1_id):
        ...
        api.InternalTest.efd_finish_retry(m1_s1_t1_id, m1_s1_t1_retry_number, TestStatus.PASS, is_final_retry)
    ...
    while api.InternalTest.efd_should_retry(m1_s1_t2_id):
        ...
        api.InternalTest.efd_finish_retry(m1_s1_t2_id, m1_s1_t2_retry_number, TestStatus.PASS, is_final_retry)
