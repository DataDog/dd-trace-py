...
class TestCIITRMixin:
    ...
    def test_api_is_item_itr_skippable_test_level(self):
        with set_up_mock_civisibility(
            ...
            assert api.Test.is_itr_skippable(non_skippable_suite_skippable_test_id) is False
    ...
    def test_api_is_item_itr_skippable_suite_level(self):
        with set_up_mock_civisibility(
            ...
            assert api.TestSuite.is_itr_skippable(non_skippable_module_skippable_suite_id) is False
