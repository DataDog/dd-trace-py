"""Fake test runner that uses EFD where all tests except the retried one pass
...
def run_tests():
    # START DISCOVERY
    api.InternalTestSession.discover("manual_efd_mix_fail", "dd_manual_test_fw", "1.0.0")
    ...
    while api.InternalTest.efd_should_retry(m1_s1_t1_id):
        ...
        api.InternalTest.efd_finish_retry(m1_s1_t1_id, m1_s1_t1_retry_number, TestStatus.FAIL, is_final_retry, final_status)
    ...
    while api.InternalTest.efd_should_retry(m1_s1_t2_id):
        ...
        final_status = TestStatus.FAIL if is_final_retry else None
        api.InternalTest.efd_finish_retry(m1_s1_t2_id, m1_s1_t2_retry_number, TestStatus.FAIL, is_final_retry, final_status)
