...
def main():
    ...
    api.CISession.discover("manual_test_all_skip", "dd_manual_test_fw", "1.0.0")
    ...
    api.CITest.finish(suite_1_test_1_id, api.CITestStatus.SKIP, skip_reason="This test was skipped")
    api.CITest.start(suite_1_test_2_id)
    api.CITest.finish(suite_1_test_2_id, api.CITestStatus.SKIP, skip_reason="This test was skipped")
    api.CITest.start(suite_1_test_3_id)
    api.CITest.finish(suite_1_test_3_id, api.CITestStatus.SKIP, skip_reason="This test was skipped")
    api.CITest.start(suite_1_test_3_retry_1_id)
    api.CITest.finish(
        suite_1_test_3_retry_1_id,
        api.CITestStatus.SKIP,
        skip_reason="This test was skipped",
    )
    api.CITest.start(suite_1_test_3_retry_2_id)
    api.CITest.finish(
        suite_1_test_3_retry_2_id,
        api.CITestStatus.SKIP,
        skip_reason="This test was skipped",
    )
    ...
    api.CITest.mark_skip(suite_2_test_1_id, skip_reason="This test was skipped with mark_skip")
    api.CITest.start(suite_2_test_2_id)
    api.CITest.mark_skip(suite_2_test_2_id, skip_reason="This test was skipped with mark_skip")
    api.CITest.start(suite_2_test_3_id)
    api.CITest.mark_skip(suite_2_test_3_id, skip_reason="This test was skipped with mark_skip")
    api.CITest.start(suite_2_test_3_retry_1_id)
    api.CITest.mark_skip(suite_2_test_3_retry_1_id, skip_reason="This test was skipped with mark_skip")
    api.CITest.start(suite_2_test_3_retry_2_id)
    api.CITest.mark_skip(suite_2_test_3_retry_2_id, skip_reason="This test was skipped with mark_skip")
    api.CITest.start(suite_2_test_3_retry_3_id)
    api.CITest.mark_skip(suite_2_test_3_retry_3_id, skip_reason="This test was skipped with mark_skip")
