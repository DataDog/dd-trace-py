...
def run_tests():
    ...
    api.InternalTest.finish(m1_s1_t1_id, TestStatus.PASS, final=False)  # Not final - EFD retries will follow
    # Hack duration:
    ...
    api.InternalTest.mark_pass(m1_s1_t2_id, final=False)  # Not final - EFD retries will follow
