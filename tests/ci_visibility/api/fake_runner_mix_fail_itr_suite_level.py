...
def main():
    ...
    # START DISCOVERY
    api.InternalTestSession.discover("manual_test_mix_fail_itr_suite_level", "dd_manual_test_fw", "1.0.0")
    ...
    api.InternalTestSuite.mark_itr_unskippable(suite_6_id)
    ...
    api.InternalTest.add_coverage_data(
        suite_1_test_1_id, {Path("my_file_1.py"): CoverageLines.from_list([1, 2, 3, 4, 8, 9])}
    )
    ...
    api.InternalTest.add_coverage_data(
        suite_1_id, {suite_1_test_3_abs_path_1: CoverageLines.from_list([1, 2, 3, 4, 8, 9])}
    )
    ...
    api.InternalTest.mark_itr_forced_run(suite_6_id)
