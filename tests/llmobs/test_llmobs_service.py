...
def test_submit_evaluation_span_context_incorrect_type_raises_error(llmobs, mock_llmobs_logs):
    with pytest.raises(
        TypeError, match="`span_context` must be a dictionary containing both span_id and trace_id keys."
    ):
