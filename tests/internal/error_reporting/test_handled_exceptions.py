...
def test_import_module():
    ...
    from tests.internal.error_reporting.sample_module_to_instrument import AClass
    from tests.internal.error_reporting.sample_module_to_instrument import a_function_at_the_root_level
