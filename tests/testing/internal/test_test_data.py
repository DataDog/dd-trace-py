...
class TestTestItem:
    ...
    def test_test_item_start_with_default_time(self) -> None:
        ...
        with patch("ddtrace.internal.utils.Time.time_ns", return_value=1000000000):
            item.start()
    ...
    def test_finish(self) -> None:
        ...
        with patch("ddtrace.internal.utils.Time.time_ns", return_value=2000000000):
            item.finish()
    ...
    def test_seconds_so_far(self) -> None:
        ...
        with patch("ddtrace.internal.utils.Time.time_ns", return_value=3000000000):
