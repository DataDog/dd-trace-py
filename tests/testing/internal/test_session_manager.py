...
class TestSessionManagerITRCorrelationId:
    def test_session_manager_propagates_itr_correlation_id_to_session_and_metadata(self) -> None:
        session_manager = (
            session_manager_mock()
        ...
        assert session_manager.writer.metadata["test"]["itr_correlation_id"] == "itr-correlation-id"
