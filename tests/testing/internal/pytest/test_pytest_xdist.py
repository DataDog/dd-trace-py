...
class TestWarnIfWorkerManifestUnusable:
    def test_warns_when_worker_cannot_read_generated_manifest(
        ...
        assert "could not read the manifest generated by its controller" in caplog.text

    def test_silent_when_worker_has_no_generated_manifest(
        self, monkeypatch: pytest.MonkeyPatch, caplog: pytest.LogCaptureFixture
    ) -> None:
