...
def override_third_party_packages(packages: list[str]):
    ...
    try:
        _wrapped = _package_for_root_module_mapping.__wrapped__  # type: ignore[attr-defined]
        original_mapping = _wrapped.__callonce_result__
    except AttributeError:
    ...
    try:
        ...
        _wrapped2 = _package_for_root_module_mapping.__wrapped__  # type: ignore[attr-defined]
        if original_mapping is not None:
            _wrapped2.__callonce_result__ = original_mapping
        else:
            del _wrapped2.__callonce_result__
