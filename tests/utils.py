...
class TestSpanContainer(object):
    ...
    def _ensure_test_spans(self, spans):
        ...
        :param spans: List of :class:`ddtrace.trace.internal.span.Span` or :class:`tests.utils.span.TestSpan`
        :type spans: list
...
class TestSpan(Span):
    """
    Test wrapper for a :class:`ddtrace.trace.internal.span.Span` that provides additional functions and assertions
    ...
    def __init__(self, span):
        ...
        :param span: The :class:`ddtrace.trace.internal.span.Span` to wrap
    ...
    def __getattr__(self, key):
        """
        First look for property on the base :class:`ddtrace.trace.internal.span.Span`
        otherwise return this object's attribute
        """
    ...
    def __setattr__(self, key, value):
        """Pass through all assignment to the base :class:`ddtrace.trace.internal.span.Span`"""
        return setattr(self._span, key, value)

    def __eq__(self, other):
        """
        Custom equality code to ensure we are using the base :class:`ddtrace.trace.internal.span.Span.__eq__`
...
class TestSpanNode(TestSpan, TestSpanContainer):
    ...
    Each :class:`tests.utils.span.TestSpanNode` represents the current :class:`ddtrace.trace.internal.span.Span`
