...
class Contrib_TestClass_For_Threats:
    ...
    def test_trace_tagging(self, interface, root_span, get_tag, get_metric, exploit_prevention_enabled, api_security_enabled):
        with override_global_config(dict(_asm_enabled=True, _asm_static_rule_file=rules.RULES_TRACE_TAGGING, _ep_enabled=exploit_prevention_enabled, _api_security_enabled=api_security_enabled)):
            self.update_tracer(interface)
