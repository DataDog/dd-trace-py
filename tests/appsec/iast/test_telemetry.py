...
try:
    from ddtrace._appsec.iast._metrics import TELEMETRY_DEBUG_VERBOSITY
    from ddtrace._appsec.iast._metrics import TELEMETRY_INFORMATION_VERBOSITY
    from ddtrace._appsec.iast._metrics import TELEMETRY_MANDATORY_VERBOSITY
    from ddtrace._appsec.iast._metrics import metric_verbosity
    from ddtrace._appsec.iast._patch_modules import patch_iast
