...
from ddtrace._appsec.iast._overhead_control_engine import MAX_REQUESTS
from ddtrace._appsec.iast._overhead_control_engine import MAX_VULNERABILITIES_PER_REQUEST
