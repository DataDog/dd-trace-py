...
def test_regression_operator_add_re_compile():
    try:
...
def test_string_operator_add_one_tainted():
...
def test_string_operator_add_two():
    string_input = taint_pyobject(
        pyobject="foo",
...
def test_string_operator_add_one_tainted_mixed_bytearray_bytes():
    string_input = taint_pyobject(
...
def test_string_operator_add_two_mixed_bytearray_bytes():
    string_input = taint_pyobject(
...
def test_string_operator_add_bytearrays():
    string_input = taint_pyobject(
        pyobject=bytearray(b"foo"), source_name="foo", source_value="foo", source_origin=OriginType.PARAMETER
    )
    assert get_tainted_ranges(string_input)
