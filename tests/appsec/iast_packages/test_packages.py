...
def template_venv():
    ...
    """
    print("JJJ starting template_venv")
    start = time()
    ...
    print("JJJ ending template_venv, took: ", time() - start)
...
def venv(template_venv):
    ...
    print("JJJ venv for %s took" % cloned_venv_dir, end - start)
...
def test_flask_packages_not_patched(package, venv):
    print("JJJ starting test_flask_packages_not_patched for package %s " % package)
    start = time()
    ...
    print("JJJ test_flask_packages_not_patched took", end - start)
...
def test_flask_packages_patched(package, venv):
    print("JJJ starting test_flask_packages_patched for package %s" % package)
    start = time()
    should_skip, reason = package.skip
    if should_skip:
        pytest.skip(reason)
    ...
    print("JJJ test_flask_packages_patched took", end - start)
...
def test_flask_packages_propagation(package, venv, printer):
    print("JJJ starting test_flask_packages_propagation for package %s" % package)
    start = time()
    should_skip, reason = package.skip
    if should_skip:
        pytest.skip(reason)
    ...
    print("JJJ test_flask_packages_propagation took", end - start)
...
def test_packages_not_patched_import(package, venv):
    print("JJJ starting test_packages_not_patched_import for package %s" % package)
    start = time()
    should_skip, reason = package.skip
    if should_skip:
        pytest.skip(reason)
    ...
    print("JJJ test_packages_not_patched_import took", end - start)
...
def test_packages_patched_import(package, venv):
    ...
    print("JJJ starting test_packages_patched_import for package %s" % package)
    start = time()
    ...
    print("JJJ test_packages_patched_import took", end - start)
