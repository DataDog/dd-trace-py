...
from tests.appsec.appsec.test_telemetry import _get_appsec_metrics
...
class FlaskAppSecTestCase(BaseFlaskTestCase):
    ...
    def inject_fixtures(self, telemetry_writer, test_agent_session):  # noqa: F811
        self.telemetry_writer = telemetry_writer
        self.test_agent_session = test_agent_session
    ...
    def test_telemetry_metrics_block(self):
        ...
        _assert_generate_metrics(
            _get_appsec_metrics(self.test_agent_session, self.telemetry_writer),
