...
class PytestTestCase(PytestTestCaseBase):
    def test_span_contains_benchmark(self):
        ...
        assert isinstance(spans[0].get_metric(BENCHMARK_MEAN), float)
        assert isinstance(spans[0].get_metric(BENCHMARK_RUN), float)
        assert isinstance(spans[0].get_metric(STATISTICS_HD15IQR), float)
        assert isinstance(spans[0].get_metric(STATISTICS_IQR), float)
        assert isinstance(spans[0].get_metric(STATISTICS_IQR_OUTLIERS), float)
        assert isinstance(spans[0].get_metric(STATISTICS_LD15IQR), float)
        assert isinstance(spans[0].get_metric(STATISTICS_MAX), float)
        assert isinstance(spans[0].get_metric(STATISTICS_MEAN), float)
        assert isinstance(spans[0].get_metric(STATISTICS_MEDIAN), float)
        assert isinstance(spans[0].get_metric(STATISTICS_MIN), float)
        assert isinstance(spans[0].get_metric(STATISTICS_OPS), float)
        assert isinstance(spans[0].get_tag(STATISTICS_OUTLIERS), str)
        assert isinstance(spans[0].get_metric(STATISTICS_Q1), float)
        assert isinstance(spans[0].get_metric(STATISTICS_Q3), float)
        assert isinstance(spans[0].get_metric(STATISTICS_N), float)
        assert isinstance(spans[0].get_metric(STATISTICS_STDDEV), float)
        assert isinstance(spans[0].get_metric(STATISTICS_STDDEV_OUTLIERS), float)
        assert isinstance(spans[0].get_metric(STATISTICS_TOTAL), float)
