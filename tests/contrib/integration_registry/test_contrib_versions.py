...
def _parse_version_spec(version_spec: str) -> Optional[Version]:
...
def test_documented_vs_tested_versions(documented_versions: Dict[str, str], registry_data: list[dict]):
