...
# Note: modify_settings not yet available, have to hack around
...
class DjangoMiddlewareTest(DjangoTraceTestCase):
    ...
    def test_middleware_trace_errors(self):
        ...
        eq_(span.resource, 'tests.contrib.django_legacy.app.views.ForbiddenView')
    ...
    def test_middleware_trace_function_based_view(self):
        ...
        eq_(span.resource, 'tests.contrib.django_legacy.app.views.function_view')
    ...
    def test_middleware_trace_error_500(self):
        ...
        eq_(span.resource, 'tests.contrib.django_legacy.app.views.error_500')
    ...
    def test_middleware_trace_callable_view(self):
        ...
        eq_(span.resource, 'tests.contrib.django_legacy.app.views.FeedView')
    ...
    def test_middleware_trace_lambda_based_view(self):
        ...
        eq_(span.resource, 'tests.contrib.django_legacy.app.views.<lambda>')

    @override_settings(
        MIDDLEWARE_CLASSES=[
            mc for mc in settings.MIDDLEWARE_CLASSES if mc != 'django.contrib.auth.middleware.AuthenticationMiddleware'
        ]
    )
    ...
    @override_settings(
        MIDDLEWARE_CLASSES=list(settings.MIDDLEWARE_CLASSES)+['tests.contrib.django.app.middlewares.HandleErrorMiddlewareSuccess']
    )
    ...
    @override_settings(
        MIDDLEWARE_CLASSES=list(settings.MIDDLEWARE_CLASSES)+['tests.contrib.django.app.middlewares.HandleErrorMiddlewareClientError']
    )
