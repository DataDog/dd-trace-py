...
class DjangoCacheViewTest(DjangoTraceTestCase):
    ...
    def test_cached_view(self):
        ...
        expected_meta_view = {
            'django.cache.backend': u'django.core.cache.backends.locmem.LocMemCache',
            'django.cache.key': u'views.decorators.cache.cache_page..GET.acf56c4cd92ebf196f8c35d84d0af375.d41d8cd98f00b204e9800998ecf8427e.en-us',
            'env': u'test',
        }

        expected_meta_header = {
            'django.cache.backend': u'django.core.cache.backends.locmem.LocMemCache',
            'django.cache.key': u'views.decorators.cache.cache_header..acf56c4cd92ebf196f8c35d84d0af375.en-us',
            'env': u'test',
        }
