...
class TestCylconePatch(PatchTestCase.Base):
    ...
    def assert_module_patched(self, cyclone):
        ...
        self.assert_wrapped(cyclone.web.RequestHandler._deferred_handler)
        self.assert_wrapped(cyclone.web.RequestHandler.render_string)
        self.assert_wrapped(cyclone.web.RequestHandler.finish)
    ...
    def assert_not_module_patched(self, cyclone):
        ...
        self.assert_not_wrapped(cyclone.web.RequestHandler._deferred_handler)
        self.assert_not_wrapped(cyclone.web.RequestHandler.render_string)
        self.assert_not_wrapped(cyclone.web.RequestHandler.finish)
    ...
    def assert_not_module_double_patched(self, cyclone):
        ...
        self.assert_not_double_wrapped(cyclone.web.RequestHandler._deferred_handler)
        self.assert_not_double_wrapped(cyclone.web.RequestHandler.render_string)
        self.assert_not_double_wrapped(cyclone.web.RequestHandler.finish)
