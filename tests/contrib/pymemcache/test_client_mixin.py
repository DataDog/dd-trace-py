...
class PymemcacheClientTestCaseMixin(unittest.TestCase):
    ...
    def check_spans(self, num_expected, resources_expected):
        """A helper for validating basic span information."""
        spans = self.get_spans()
        self.assertEqual(num_expected, len(spans))

        for span, resource in zip(spans, resources_expected):
    ...
    def make_client(self, mock_socket_values, **kwargs):
        self.client = pymemcache.client.base.Client(None, **kwargs)
    ...
    def test_delete_many_found(self):
        ...
        self.check_spans(2, ["add", "delete_many"])
