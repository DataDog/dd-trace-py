...
class TestTornadoWeb(TornadoTestCase):
    ...
    def test_http_exception_handler(self):
        ...
        assert 1 == request_span.error
        assert "HTTP 501: Not Implemented (unavailable)" == request_span.get_tag(ERROR_MESSAGE)
    ...
    def test_http_exception_500_handler(self):
        ...
        assert 1 == request_span.error
        assert "HTTP 500: Server Error (server error)" == request_span.get_tag(ERROR_MESSAGE)
