...
class TestTornadoWebWrapper(TornadoTestCase):
    ...
    def test_nested_wrap_handler(self):
        ...
        assert self.get_url("/nested_wrap/") == request_span._get_str_attribute(http.URL)
        ...
        assert nested_span._get_str_attribute("component") == "tornado"
    ...
    def test_nested_exception_wrap_handler(self):
        ...
        assert self.get_url("/nested_exception_wrap/") == request_span._get_str_attribute(http.URL)
        ...
        assert "Ouch!" == nested_span._get_str_attribute(ERROR_MSG)
        assert "Exception: Ouch!" in nested_span._get_str_attribute("error.stack")
        # check durations because of the yield sleep
        assert request_span.duration >= 0.05
        assert nested_span.duration >= 0.05
        assert request_span._get_str_attribute("component") == "tornado"
    ...
    def test_sync_nested_wrap_handler(self):
        ...
        assert "GET" == request_span._get_str_attribute("http.method")
        assert_span_http_status_code(request_span, 200)
        assert self.get_url("/sync_nested_wrap/") == request_span._get_str_attribute(http.URL)
        assert 0 == request_span.error
        # check nested span
        nested_span = traces[0][1]
        assert "tornado-web" == nested_span.service
    ...
    def test_sync_nested_exception_wrap_handler(self):
        ...
        assert "GET" == request_span._get_str_attribute("http.method")
        assert_span_http_status_code(request_span, 500)
        assert self.get_url("/sync_nested_exception_wrap/") == request_span._get_str_attribute(http.URL)
        assert 1 == request_span.error
        assert "Ouch!" == request_span._get_str_attribute(ERROR_MSG)
        assert "Exception: Ouch!" in request_span._get_str_attribute("error.stack")
        # check nested span
    ...
    def test_nested_wrap_executor_handler(self):
        ...
        assert "GET" == request_span._get_str_attribute("http.method")
        assert_span_http_status_code(request_span, 200)
        assert self.get_url("/executor_wrap_handler/") == request_span._get_str_attribute(http.URL)
        assert 0 == request_span.error
    ...
    def test_nested_exception_wrap_executor_handler(self):
        ...
        assert "GET" == request_span._get_str_attribute("http.method")
        assert_span_http_status_code(request_span, 500)
        assert self.get_url("/executor_wrap_exception/") == request_span._get_str_attribute(http.URL)
        assert 1 == request_span.error
        assert "Ouch!" == request_span._get_str_attribute(ERROR_MSG)
        assert "Exception: Ouch!" in request_span._get_str_attribute("error.stack")
        # check nested span
