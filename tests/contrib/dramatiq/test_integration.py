...
class DramatiqSnapshotTests(unittest.TestCase):
    ...
    @snapshot(wait_for_num_traces=2, ignores=SNAPSHOT_IGNORES)
    ...
    @snapshot(wait_for_num_traces=0, ignores=SNAPSHOT_IGNORES)
    ...
    @snapshot(ignores=["meta.error.message", "meta.error.stack"] + SNAPSHOT_IGNORES, wait_for_num_traces=1)
