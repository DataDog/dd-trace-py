...
class MysqlConnectorTestCase(SQLAlchemyTestMixin, TracerTestCase):
    ...
    def check_meta(self, span):
        ...
        self.assertEqual(span._get_str_attribute("out.host"), MYSQL_CONFIG["host"])
        self.assertEqual(span._get_numeric_attribute("network.destination.port"), MYSQL_CONFIG["port"])
    ...
    def test_engine_execute_errors(self):
        ...
        self.assertEqual(span._get_str_attribute("error.type"), "mysql.connector.errors.ProgrammingError")
        self.assertTrue("Table 'test.a_wrong_table' doesn't exist" in span._get_str_attribute(ERROR_MSG))
        self.assertTrue("Table 'test.a_wrong_table' doesn't exist" in span._get_str_attribute("error.stack"))
