...
class TestValkeyPatch(PatchTestCase.Base):
    __integration_name__ = "valkey"
    __module_name__ = "valkey"
    __patch_func__ = patch
    __unpatch_func__ = unpatch
    __get_version__ = get_version

    def assert_module_patched(self, valkey):
        pass

    def assert_not_module_patched(self, valkey):
        pass

    def assert_not_module_double_patched(self, valkey):
        pass
