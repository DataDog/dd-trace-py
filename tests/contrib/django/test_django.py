...
if django.VERSION >= (2, 0, 0):
    override = dict(
        MIDDLEWARE={
            'append': 'tests.contrib.django.middleware.CatchExceptionMiddleware',
        }
    )
else:
    override = dict(
...
if django.VERSION >= (2, 0, 0):
    override = dict(
        MIDDLEWARE={
            'append': 'tests.contrib.django.middleware.HandleErrorMiddlewareSuccess',
        }
    )
else:
    override = dict(
