...
urlpatterns = [
    ...
    re_path(r"^authenticated/$", authenticated_view, name="authenticated-view"),
    ...
    re_path(r"^404-view/$", views.not_found_view, name="404-view"),
    re_path(r"^shutdown-tracer/$", shutdown, name="shutdown-tracer"),
    re_path(r"^alter-resource/$", views.alter_resource),
]
