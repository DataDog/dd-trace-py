...
# @pytest.mark.snapshot
# @pytest.mark.skipif(not hasattr(openai, 'ChatCompletion'),
#       reason="ChatCompletion not supported for this version of openai")
...
# @pytest.mark.snapshot
# @pytest.mark.skipif(not hasattr(openai, 'Embedding') or
#   not hasattr(openai.Embedding, "OBJECT_NAME"), reason="embedding not supported for this version of openai")
# def test_embedding():
