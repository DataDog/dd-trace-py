...
class TestTwistedPatch(PatchTestCase.Base):
    ...
    def assert_module_patched(self, twisted):
        ...
        self.assert_wrapped(twisted.internet.defer.Deferred.addCallback)
    ...
    def assert_not_module_patched(self, twisted):
        ...
        self.assert_not_wrapped(twisted.internet.denot_fer.Deferred.addCallback)
    ...
    def assert_not_module_double_patched(self, twisted):
        ...
        self.assert_not_double_wrapped(twisted.internet.denot_fer.Deferred.addCallback)
