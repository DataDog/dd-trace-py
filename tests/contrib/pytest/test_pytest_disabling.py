...
class PytestDisablingTestCase(PytestTestCaseBase):
    ...
    def test_disabled_test(self):
        ...
        assert test_span_disabled._get_str_attribute("test.test_management.is_quarantined") is None
        assert test_span_disabled._get_str_attribute("test.test_management.is_test_disabled") == "true"
        assert test_span_disabled._get_str_attribute("test.status") == "skip"

        [test_span_pass] = _get_spans_from_list(spans, "test", "test_pass")
        assert test_span_pass._get_str_attribute("test.test_management.is_quarantined") is None
        assert test_span_pass._get_str_attribute("test.test_management.is_test_disabled") is None
        assert test_span_pass._get_str_attribute("test.status") == "pass"
    ...
    def test_disabled_and_quarantined_test(self):
        ...
        assert test_span._get_str_attribute("test.test_management.is_quarantined") == "true"
        assert test_span._get_str_attribute("test.test_management.is_test_disabled") == "true"
