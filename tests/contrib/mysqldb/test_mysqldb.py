...
class TestMysqlPatch(MySQLCore, TracerTestCase):
    ...
    def test_mysqldb_dbm_propagation_enabled(self):
        conn, tracer = self._get_conn_tracer()
    ...
    def test_mysqldb_dbm_propagation_comment_with_global_service_name_configured(self):
    ...
    def test_mysqldb_dbm_propagation_comment_integration_service_name_override(self):
        """tests if dbm comment is set in mysql"""
        db_name = MYSQL_CONFIG["database"]
    ...
    def test_mysqldb_dbm_propagation_comment_pin_service_name_override(self):
        """tests if dbm comment is set in mysql"""
        db_name = MYSQL_CONFIG["database"]
    ...
    def test_mysqldb_dbm_propagation_comment_peer_service_enabled(self):
