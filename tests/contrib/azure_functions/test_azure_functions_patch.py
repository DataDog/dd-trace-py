...
from ddtrace.contrib.azure_functions import get_version
from ddtrace.contrib.azure_functions.patch import patch


try:
    from ddtrace.contrib.azure_functions.patch import unpatch
except ImportError:
    unpatch = None
