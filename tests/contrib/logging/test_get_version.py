...
def test_get_version_returns_empty_string_without_deprecation_warning() -> None:
    """get_version() returns "" and must not touch logging.__version__, even if it would warn."""
