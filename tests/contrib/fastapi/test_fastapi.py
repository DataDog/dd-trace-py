...
def test_read_homepage(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.url") == "http://testserver/"
    ...
    assert request_span._get_str_attribute("component") == "fastapi"
...
def test_read_item_success(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/items/{item_id}"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/foo"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_read_item_bad_token(client, tracer, test_spans):
    ...
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/bar"
    assert request_span._get_str_attribute("http.status_code") == "401"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_read_item_nonexistent_item(client, tracer, test_spans):
    ...
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/foobar"
    assert request_span._get_str_attribute("http.status_code") == "404"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_read_item_query_string(client, tracer, test_spans):
    ...
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/foo?q=query"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("http.query.string") == "q=query"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_200_multi_query_string(client, tracer, test_spans):
    ...
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/foo?name=Foo&q=query"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("http.query.string") == "name=Foo&q=query"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_create_item_success(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/items/"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "POST"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("http.query.string") is None
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_create_item_duplicate_item(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.method") == "POST"
    assert request_span._get_str_attribute("http.url") == "http://testserver/items/"
    assert request_span._get_str_attribute("http.status_code") == "400"
    assert request_span._get_str_attribute("http.query.string") is None
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_invalid_path(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") is None
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/invalid_path"
    assert request_span._get_str_attribute("http.status_code") == "404"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_streaming_response(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/stream"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/stream"
    assert request_span._get_str_attribute("http.query.string") is None
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_file_response(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/file"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/file"
    assert request_span._get_str_attribute("http.query.string") is None
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_path_param_aggregate(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/users/{userid:str}"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/users/testUserID"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_mid_path_param_aggregate(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/users/{userid:str}/info"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/users/testUserID/info"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
def test_multi_path_param_aggregate(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("http.route") == "/users/{userid:str}/{attribute:str}"
    assert request_span.error == 0
    assert request_span._get_str_attribute("http.method") == "GET"
    assert request_span._get_str_attribute("http.url") == "http://testserver/users/testUserID/name"
    assert request_span._get_str_attribute("http.status_code") == "200"
    assert request_span._get_str_attribute("component") == "fastapi"
    assert request_span._get_str_attribute("span.kind") == "server"
...
async def test_multiple_requests(fastapi_application, tracer, test_spans):
    ...
    assert r1_span._get_str_attribute("http.url") == "http://testserver/"
    ...
    assert r2_span._get_str_attribute("http.url") == "http://testserver/"
...
def test_host_header(client, tracer, test_spans, host):
    ...
    assert request_span._get_str_attribute("http.url") == "http://%s/asynctask" % (host,)
...
def test_baggage_span_tagging_default(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("baggage.user.id") == "123"
    assert request_span._get_str_attribute("baggage.account.id") == "456"
    # Since "region" is not in the default list, its baggage tag should not be present.
    assert request_span._get_str_attribute("baggage.region") is None
...
def test_baggage_span_tagging_no_headers(client, tracer, test_spans):
    ...
    assert request_span._get_str_attribute("baggage.user.id") is None
    assert request_span._get_str_attribute("baggage.account.id") is None
    assert request_span._get_str_attribute("baggage.session.id") is None
