...
class TestKombuPatch(TracerTestCase):
    ...
    def _assert_spans(self):
        ...
        self.assertEqual(producer_span._get_str_attribute("out.vhost"), "/")
        self.assertEqual(producer_span._get_str_attribute("out.host"), "127.0.0.1")
        self.assertEqual(producer_span._get_str_attribute("kombu.exchange"), "tasks")
        self.assertEqual(producer_span._get_numeric_attribute("kombu.body_length"), 18)
        self.assertEqual(producer_span._get_str_attribute("kombu.routing_key"), "tasks")
        self.assertEqual(producer_span.resource, "tasks")
        self.assertEqual(producer_span._get_str_attribute("component"), "kombu")
        self.assertEqual(producer_span._get_str_attribute("span.kind"), "producer")
        ...
        self.assertEqual(consumer_span._get_str_attribute("kombu.exchange"), "tasks")
        self.assertEqual(consumer_span._get_str_attribute("kombu.routing_key"), "tasks")
        self.assertEqual(consumer_span._get_str_attribute("component"), "kombu")
        self.assertEqual(consumer_span._get_str_attribute("span.kind"), "consumer")
