...
class TestLongRunningSpan(TracerTestCase):
    ...
    def test_long_running_span_basic_lifecycle(self):
        ...
        span._set_attribute("ray.submission_id", "test-submission-123")
        ...
        self.assertGreater(span._get_numeric_attribute("_dd.partial_version"), 0)
        self.assertEqual(span._get_str_attribute("ray.job.status"), "RUNNING")
        ...
        self.assertIsNone(span._get_numeric_attribute("_dd.partial_version"))
        self.assertEqual(span._get_numeric_attribute("_dd.was_long_running"), 1)
    ...
    def test_not_long_running_span(self):
        ...
        self.assertIsNone(span._get_numeric_attribute("_dd.partial_version"))
        self.assertIsNone(span._get_str_attribute("ray.job.status"))
        ...
        self.assertIsNone(span._get_numeric_attribute("_dd.partial_version"))
        self.assertIsNone(span._get_numeric_attribute("_dd.was_long_running"))
        self.assertTrue(span.finished)
    ...
    def test_multiple_long_running_spans_same_submission(self):
        ...
        span1._set_attribute("ray.submission_id", submission_id)

        span2 = self.tracer.start_span("test.span2", service="test-service")
        span2._set_attribute("ray.submission_id", submission_id)
        ...
        self.assertGreater(span1._get_numeric_attribute("_dd.partial_version"), 0)
        self.assertEqual(span1._get_str_attribute("ray.job.status"), "RUNNING")

        self.assertGreater(span2._get_numeric_attribute("_dd.partial_version"), 0)
        self.assertEqual(span2._get_str_attribute("ray.job.status"), "RUNNING")
        ...
        self.assertEqual(span1._get_numeric_attribute("_dd.was_long_running"), 1)
        self.assertEqual(span2._get_numeric_attribute("_dd.was_long_running"), 1)
    ...
    def test_long_running_span_hierarchies_and_context(self):
        ...
        parent_span._set_attribute("ray.submission_id", submission_id)
        ...
        self.assertEqual(child1._get_numeric_attribute("_dd.was_long_running"), 1)
        ...
        self.assertIsNone(child2._get_numeric_attribute("_dd.partial_version"))
        ...
        self.assertGreater(parent_span._get_numeric_attribute("_dd.partial_version"), 0)
        self.assertEqual(parent_span._get_str_attribute("ray.job.status"), "RUNNING")
        self.assertGreater(child3._get_numeric_attribute("_dd.partial_version"), 0)
        self.assertEqual(child3._get_str_attribute("ray.job.status"), "RUNNING")
        ...
        self.assertEqual(parent_span._get_numeric_attribute("_dd.was_long_running"), 1)
        self.assertEqual(child3._get_numeric_attribute("_dd.was_long_running"), 1)
