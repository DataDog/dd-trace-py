...
class TestRayPatch(PatchTestCase.Base):
    ...
    def assert_module_patched(self, ray):
        ...
        self.assert_wrapped(ray._private.worker.disconnect)
    ...
    def assert_not_module_patched(self, ray):
        ...
        self.assert_not_wrapped(ray._private.worker.disconnect)
    ...
    def assert_not_module_double_patched(self, ray):
        ...
        self.assert_not_double_wrapped(ray._private.worker.disconnect)
