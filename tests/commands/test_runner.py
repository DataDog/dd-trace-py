...
def test_info_no_configs():
    ...
    assert (
        stdout == b"\x1b[94m\x1b[1mTracer Configurations:\x1b[0m\n    "
        b"Tracer enabled: True\n"
        b"    Application Security enabled: False\n    "
        b"IAST enabled (experimental): False\n    "
        b"Debug logging: False\n    "
        b"Writing traces to: http://localhost:8126\n    "
        b"Agent error: Agent not reachable at http://localhost:8126. Exception raised: [Errno 61] Connection refused\n"
        ...
        b"\x1b[92m\x1b[1mTagging:\x1b[0m\n    "
        b"DD Service: None\n    DD Env: None\n    DD Version: None\n    Global Tags: None\n    "
        b"Tracer Tags: None\n\n\x1b[96m\x1b[1mSummary\x1b[0m\n\n\x1b[91mERROR: It looks like you have an agent error:"
        b" 'Agent not reachable at http://localhost:8126. Exception raised: [Errno 61] Connection refused'\n If you're"
        b" experiencing a connection error, please make sure you've followed the setup for your particular "
        b"environment so that the tracer and Datadog agent are configured properly to connect, and that "
        b"the Datadog agent is running: "
        b"https://ddtrace.readthedocs.io/en/stable/troubleshooting.html#failed-to-send-traces-connectionrefusederror"
        b"\nIf your issue is not a connection error then please reach out to support for further assistance: "
        b"https://docs.datadoghq.com/help/\x1b[0m\n\n\x1b[93mWARNING SERVICE NOT SET: It is recommended that a "
        b"service tag be set for all traced applications. For more information please see "
        b"https://ddtrace.readthedocs.io/en/stable/troubleshooting.html\x1b[0m\n\n\x1b[93mWARNING ENV NOT SET: "
        b"It is recommended that an env tag be set for all traced applications. For more information please see "
