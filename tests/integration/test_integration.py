...
def test_logging_during_tracer_init_succeeds_when_debug_logging_and_logs_injection_enabled(
    ...
    assert (
        b"[dd.service=test_logging_during_tracer_init_succeeds_when_debug_logging_and_logs_injection_enabled_0 " + 
        b"dd.env= dd.version= dd.trace_id=0 dd.span_id=0]" in err
