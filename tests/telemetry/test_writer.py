...
import ddtrace.settings.exception_replay
    ...
    expected = [
        ...
        {"name": "DD_TRACE_EXPERIMENTAL_FEATURES_ENABLED", "origin": "default", "value": "DD_RUNTIME_METRICS_ENABLED"},
        {"name": "DD_TRACE_EXPERIMENTAL_RUNTIME_ID_ENABLED", "origin": "default", "value": True},
