...
def get_patterns(suite: str) -> t.Set[str]:
    ...
    'ddtrace/internal/encoding.py', 'ddtrace/internal/exceptions.py', 'ddtrace/internal/forksafe.py',
    'ddtrace/internal/gitmetadata.py', 'ddtrace/internal/glob_matching.py', 'ddtrace/internal/hostname.py',
    'ddtrace/internal/http.py', 'ddtrace/internal/injection.py', 'ddtrace/internal/log_writer.py',
    ...
    'ddtrace/internal/processor/stats.py', 'ddtrace/internal/rate_limiter.py', 'ddtrace/internal/remoteconfig/*',
    'ddtrace/internal/runtime/*', 'ddtrace/internal/safety.py', 'ddtrace/internal/sampling.py',
    'ddtrace/internal/schema/*', 'ddtrace/internal/service.py', 'ddtrace/internal/sma.py', 'ddtrace/internal/sysdep.h',
