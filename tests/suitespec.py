...
def get_patterns(suite: str) -> t.Set[str]:
    ...
    'ddtrace/span.py', 'ddtrace/tracer.py', 'ddtrace/version.py', 'docker/*', 'hatch.toml',
    ...
    'ddtrace/settings/config.py', 'ddtrace/settings/http.py', 'ddtrace/settings/integration.py', 'ddtrace/span.py',
    'ddtrace/tracer.py', 'ddtrace/version.py', 'docker/*', 'hatch.toml', 'pyproject.toml', 'riotfile.py',
