...
def get_patterns(suite: str) -> t.Set[str]:
    ...
    'ddtrace/_trace/*', 'ddtrace/_tracing/*', 'ddtrace/auto.py', 'ddtrace/bootstrap/*', 'ddtrace/commands/*',
    'ddtrace/constants.py', 'ddtrace/context.py', 'ddtrace/debugging/*', 'ddtrace/filters.py',
    'ddtrace/internal/__init__.py', 'ddtrace/internal/_encoding.py*', 'ddtrace/internal/_rand.pyi',
    'ddtrace/internal/_rand.pyx', 'ddtrace/internal/_stdint.h', 'ddtrace/internal/_tagset.py*',
    'ddtrace/internal/_utils.*', 'ddtrace/internal/agent.py', 'ddtrace/internal/assembly.py',
    'ddtrace/internal/atexit.py', 'ddtrace/internal/compat.py', 'ddtrace/internal/constants.py',
    'ddtrace/internal/core/*', 'ddtrace/internal/datadog/__init__.py', 'ddtrace/internal/debug.py',
    'ddtrace/internal/dogstatsd.py', 'ddtrace/internal/encoding.py', 'ddtrace/internal/exceptions.py',
    ...
    'ddtrace/internal/log_writer.py', 'ddtrace/internal/logger.py', 'ddtrace/internal/metrics.py',
    ...
    'ddtrace/settings/peer_service.py', 'ddtrace/span.py', 'ddtrace/tracer.py', 'ddtrace/tracing/*',
    'ddtrace/version.py', 'docker/*', 'hatch.toml', 'pyproject.toml', 'riotfile.py', 'scripts/ddtest',
    ...
    ['.circleci/*', 'ddtrace/__init__.py', 'ddtrace/_hooks.py', 'ddtrace/_logger.py', 'ddtrace/_monkey.py',
    'ddtrace/_trace/*', 'ddtrace/_tracing/*', 'ddtrace/auto.py', 'ddtrace/bootstrap/*', 'ddtrace/commands/*',
    'ddtrace/constants.py', 'ddtrace/context.py', 'ddtrace/contrib/__init__.py', 'ddtrace/contrib/trace_utils.py',
    ...
    'ddtrace/internal/exceptions.py', 'ddtrace/internal/forksafe.py', 'ddtrace/internal/gitmetadata.py',
    'ddtrace/internal/glob_matching.py', 'ddtrace/internal/hostname.py', 'ddtrace/internal/http.py',
    'ddtrace/internal/injection.py', 'ddtrace/internal/log_writer.py', 'ddtrace/internal/logger.py',
    'ddtrace/internal/metrics.py', 'ddtrace/internal/module.py', 'ddtrace/internal/pack.h',
    'ddtrace/internal/pack_template.h', 'ddtrace/internal/packages.py', 'ddtrace/internal/peer_service/*',
    'ddtrace/internal/periodic.py', 'ddtrace/internal/processor/__init__.py', 'ddtrace/internal/processor/stats.py',
    'ddtrace/internal/rate_limiter.py', 'ddtrace/internal/runtime/*', 'ddtrace/internal/safety.py',
    'ddtrace/internal/sampling.py', 'ddtrace/internal/schema/*', 'ddtrace/internal/service.py',
    'ddtrace/internal/sma.py', 'ddtrace/internal/sysdep.h', 'ddtrace/internal/tracemethods.py',
    'ddtrace/internal/uds.py', 'ddtrace/internal/utils/*', 'ddtrace/internal/uwsgi.py', 'ddtrace/internal/wrapping/*',
    'ddtrace/internal/writer/*', 'ddtrace/pin.py', 'ddtrace/propagation/*', 'ddtrace/provider.py', 'ddtrace/py.typed',
    'ddtrace/sampler.py', 'ddtrace/sampling_rule.py', 'ddtrace/settings/__init__.py',
    ...
    'tests/snapshots/tests.contrib.urllib3.*', 'tests/suitespec.py', 'tests/utils.py']
    """
