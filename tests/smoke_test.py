...
if __name__ == "__main__":
    ...
    # profiling only works on 64bit linux and macOs
    if platform.system() in ("Linux", "Darwin") and sys.maxsize > 2**32:
        ...
        print("Skipping profiling smoke test, only supported on 64bit Linux and macOS")
