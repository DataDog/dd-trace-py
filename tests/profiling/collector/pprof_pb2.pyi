...
class Sample(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["label", b"label", "location_id", b"location_id", "value", b"value"]) -> None: ...
...
class Label(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["key", b"key", "num", b"num", "num_unit", b"num_unit", "str", b"str"]) -> None: ...
...
class Mapping(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["build_id", b"build_id", "file_offset", b"file_offset", "filename", b"filename", "has_filenames", b"has_filenames", "has_functions", b"has_functions", "has_inline_frames", b"has_inline_frames", "has_line_numbers", b"has_line_numbers", "id", b"id", "memory_limit", b"memory_limit", "memory_start", b"memory_start"]) -> None: ...
...
class Location(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["address", b"address", "id", b"id", "is_folded", b"is_folded", "line", b"line", "mapping_id", b"mapping_id"]) -> None: ...
...
class Function(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["filename", b"filename", "id", b"id", "name", b"name", "start_line", b"start_line", "system_name", b"system_name"]) -> None: ...
