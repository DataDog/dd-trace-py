...
TEST_EVENTS = {
    ...
    memalloc.MemoryAllocSampleEvent: [
        memalloc.MemoryAllocSampleEvent(
            ...
            thread_name="MainThread",
            frames=[
                ("foobar.py", 23, "func1", "Foobax"),
                ("foobar.py", 44, "func2", "Foobaz"),
                ("foobar.py", 19, "func5", "FooBar"),
            ],
            size=34,
            capture_pct=44,
            nframes=3,
        ...
        memalloc.MemoryAllocSampleEvent(
            ...
            span_id=49393,
            frames=[
                ("foobar.py", 23, "func1", "a"),
                ("foobar.py", 44, "func2", "b"),
                ("foobar2.py", 19, "func5", "c"),
            ],
            size=68,
            capture_pct=50,
            nframes=3,
        ...
        memalloc.MemoryAllocSampleEvent(
            ...
            thread_name="MainThread",
            frames=[
                ("foobar.py", 23, "func1", "d"),
                ("foobar.py", 44, "func2", "e"),
                ("foobar.py", 19, "func5", "f"),
            ],
            size=24,
            capture_pct=90,
            nframes=3,
    ...
    memalloc.MemoryHeapSampleEvent: [
        ...
        memalloc.MemoryHeapSampleEvent(
            ...
            thread_name="MainThread",
            frames=[
                ("foobar.py", 23, "func1", "class1"),
                ("foobar.py", 44, "func2", "class2"),
                ("foobar.py", 20, "func5", "class1"),
            ],
            size=99,
            nframes=3,
            sample_size=512 * 1024,
        ...
        memalloc.MemoryHeapSampleEvent(
            ...
            thread_name="MainThread",
            frames=[
                ("foobar.py", 23, "func1", "classB"),
                ("foobar.py", 44, "func2", "classA"),
                ("foobar2.py", 19, "func5", ""),
            ],
            size=44,
            nframes=6,
