...
class TestTheFailureLogLine:
    @patch("ddtrace.internal.telemetry.telemetry_writer.add_count_metric")
    def test_the_failure_line_reports_the_classification(self, add_count_metric, caplog, ai_guard_client):
        """The client logs one line per failure; without the classification it says nothing a
        reader could act on.
        """
