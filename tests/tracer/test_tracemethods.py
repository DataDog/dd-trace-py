...
def test_trace_methods_parse():
    ...
    assert _parse_trace_methods("module[method1]") == ["module.method1"]
    assert _parse_trace_methods("module[method1,method2]") == ["module.method1", "module.method2"]
    assert _parse_trace_methods("module[method1,method2];mod2[m1,m2]") == [
        "module.method1",
        "module.method2",
        "mod2.m1",
        "mod2.m2",
    ]
    assert _parse_trace_methods("mod.submod[m1,m2,m3]") == ["mod.submod.m1", "mod.submod.m2", "mod.submod.m3"]
    assert _parse_trace_methods("mod.submod.subsubmod[m1,m2]") == ["mod.submod.subsubmod.m1", "mod.submod.subsubmod.m2"]
    assert _parse_trace_methods("mod.mod2.mod3.Class[test_method,test_method2]") == [
        "mod.mod2.mod3.Class.test_method",
        "mod.mod2.mod3.Class.test_method2",
    ]

    with pytest.raises(ValueError):
        _parse_trace_methods("module[method1, method2]")

    with pytest.raises(ValueError):
        _parse_trace_methods("module")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.method")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.method[m1,m2,]")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.method;module.method")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.method[m1];module.method[m1,m2,]")

    with pytest.raises(ValueError):
        _parse_trace_methods("module.method[[m1]")
