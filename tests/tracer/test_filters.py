...
class FilterRequestOnUrlTests(TestCase):
    def test_is_match(self):
        span = Span(name="Name")
        span.set_tag_str(URL, r"http://example.com")
    ...
    def test_is_not_match(self):
        span = Span(name="Name")
        span.set_tag_str(URL, r"http://anotherexample.com")
        filtr = FilterRequestsOnUrl("http://examp.*.com")
        trace = filtr.process_trace([span])
    ...
    def test_list_match(self):
        span = Span(name="Name")
        span.set_tag_str(URL, r"http://anotherdomain.example.com")
    ...
    def test_list_no_match(self):
        span = Span(name="Name")
        span.set_tag_str(URL, r"http://cooldomain.example.com")
        filtr = FilterRequestsOnUrl([r"http://domain\.example\.com", r"http://anotherdomain\.example\.com"])
        trace = filtr.process_trace([span])
        self.assertIsNotNone(trace)
