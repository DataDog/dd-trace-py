...
The ddtrace library's support policy for third-party libraries that we provide integrations is to test the oldest
and latest minor versions of the latest major version of each third-party library going back 2 years.
