...
- A release note for your addition generated with ``uv run --no-project --with reno reno new YOUR_TITLE_SLUG``, which will add ``releasenotes/notes/YOUR_TITLE_SLUG.yml``.
