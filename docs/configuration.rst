...
.. ddtrace-configuration-options::
   ...
   DD_SPAN_SAMPLING_RULES:
     ...
     description: |
         ...
         The "max_per_second" value must be >= 0 and has a default of no limit. 
   ...
   DD_SPAN_SAMPLING_RULES_FILE:
     type: string
     description: |
         A path to a json file containing span sampling rules organized as JSON array of objexts. 
