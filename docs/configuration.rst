...
.. ddtrace-configuration-options::
   ...
   DD_TRACE_SAMPLE_RATE:
     type: Float
     description: |
        A float, f, 0.0 <= f <= 1.0. f*100% of traces will be sampled. By default, this confiruation is unset
        and sampling is controlled by other configuration options and/or the Datadog Agent.
