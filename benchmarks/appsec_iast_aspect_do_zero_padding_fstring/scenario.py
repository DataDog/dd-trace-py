...
class IAST_Aspects_do_zero_padding_fstring(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods_py3.do_zero_padding_fstring(*["  fOobaR\t  \n"])
                else:
                    mod_unpatched_str_methods_py3.do_zero_padding_fstring(*["  fOobaR\t  \n"])
