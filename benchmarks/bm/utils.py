...
def set_log_writer(tracer):
    # mock stdout to reduce noise and reduce the number of logs generated by benchmarks
    tracer.configure(writer=LogWriter(out=mock.Mock()))
