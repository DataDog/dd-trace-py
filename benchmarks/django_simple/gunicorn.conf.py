...
def post_fork(server, worker):
    ...
    if os.environ.get("PERF_ENABLE_PROFILER") == "1":
        os.environ.update(
    ...
    if os.environ.get("PERF_ENABLE_TRACER") == "1":
...
def post_worker_init(worker):
    ...
    if os.environ.get("PERF_ENABLE_PROFILER") == "1" and os.environ.get("PERF_ENABLE_TRACER") == "0":
