...
class IAST_Aspects_do_bytearray_append(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_bytearray_append(*(bytearray(b"foobar"),))
                else:
                    mod_unpatched_str_methods.do_bytearray_append(*(bytearray(b"foobar"),))
