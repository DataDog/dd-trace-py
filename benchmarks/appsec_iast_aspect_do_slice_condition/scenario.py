...
class IAST_Aspects_do_slice_condition(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_slice_condition(*("foobar", 1, 3))
                else:
                    mod_unpatched_str_methods.do_slice_condition(*("foobar", 1, 3))
