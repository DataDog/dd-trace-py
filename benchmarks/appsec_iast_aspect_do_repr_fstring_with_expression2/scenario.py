...
class IAST_Aspects_do_repr_fstring_with_expression2(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods_py3.do_repr_fstring_with_expression2(*[])
                else:
                    mod_unpatched_str_methods_py3.do_repr_fstring_with_expression2(*[])
