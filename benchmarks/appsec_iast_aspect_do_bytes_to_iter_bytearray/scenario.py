...
class IAST_Aspects_do_bytes_to_iter_bytearray(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_bytes_to_iter_bytearray(*(b"foobar",))
                else:
                    mod_unpatched_str_methods.do_bytes_to_iter_bytearray(*(b"foobar",))
