...
class IAST_Aspects_do_encode_from_dict(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_encode_from_dict(*("foobar", "utf-8", "strict"))
                else:
                    mod_unpatched_str_methods.do_encode_from_dict(*("foobar", "utf-8", "strict"))
