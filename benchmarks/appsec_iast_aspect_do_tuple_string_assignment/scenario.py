...
class IAST_Aspects_do_tuple_string_assignment(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_tuple_string_assignment(*("foo",))
                else:
                    mod_unpatched_str_methods.do_tuple_string_assignment(*("foo",))
