...
class IAST_Aspects_do_bytearray_extend(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_bytearray_extend(*(bytearray(b"foo"), bytearray(b"bar")))
                else:
                    mod_unpatched_str_methods.do_bytearray_extend(*(bytearray(b"foo"), bytearray(b"bar")))
