...
class IAST_Aspects_do_exporttype_member_format(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_exporttype_member_format(*[])
                else:
                    mod_unpatched_str_methods.do_exporttype_member_format(*[])
