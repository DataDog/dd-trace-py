...
class IAST_Aspects_do_bytearray_to_bytes(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_bytearray_to_bytes(*(bytearray(b"foobar"),))
                else:
                    mod_unpatched_str_methods.do_bytearray_to_bytes(*(bytearray(b"foobar"),))
