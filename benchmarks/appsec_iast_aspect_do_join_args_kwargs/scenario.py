...
class IAST_Aspects_do_join_args_kwargs(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_join_args_kwargs(*("foobar", ("baz", "pok")))
                else:
                    mod_unpatched_str_methods.do_join_args_kwargs(*("foobar", ("baz", "pok")))
