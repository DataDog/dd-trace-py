...
class IAST_Aspects_do_str_to_bytes_to_bytearray_to_str(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_methods.do_str_to_bytes_to_bytearray_to_str(*["  fOobaR\t  \n"])
                else:
                    mod_unpatched_str_methods.do_str_to_bytes_to_bytearray_to_str(*["  fOobaR\t  \n"])
