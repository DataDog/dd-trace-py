...
class IAST_Aspects_do_os_path_splitext(bm.Scenario):
    iast_enabled: bool
        ...
        def _(loops):
            for _ in range(loops):
                if self.iast_enabled:
                    mod_patched_module_functions.do_os_path_splitext(*("foo/bar.txt",))
                else:
                    mod_unpatched_module_functions.do_os_path_splitext(*("foo/bar.txt",))
