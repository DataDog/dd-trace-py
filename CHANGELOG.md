...
### New Features
  ...
  - Code Security (IAST): Always report a telemetry log error when an IAST propagation error raises, regardless of whether the \_DD\_IAST\_DEBUG environment variable is enabled or not.
