...
| Native Code (C/C++/Rust/Cython) | `.cursor/rules/native-code.mdc` | `ddtrace/internal/_threads*`, `ddtrace/profiling/collector/_memalloc*`, `ddtrace/internal/datadog/profiling/`, `src/native/`, `*.pyx`, `*.cpp`, `*.c`, `*.rs` |
