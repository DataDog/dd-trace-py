...
| `migrate-profiling-new-cpython` | Adding Continuous Profiler support for a new CPython minor (3.16+). Phase detection, gates, gotchas. |
...
| Profiling new CPython minor                                     | `.cursor/rules/profiling-new-cpython.mdc`                               | `ddtrace/internal/datadog/profiling/`, `ddtrace/profiling/`, `setup.py`, version registry                                                          |
