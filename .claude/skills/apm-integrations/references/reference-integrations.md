...
| messaging | `rq/patch.py` | `kafka/patch.py`, `kombu/patch.py` | RQ enqueue/process boundaries use shared messaging events + `context_with_event`; Kafka and Kombu retain legacy Pin + `tracer.trace` patterns |
