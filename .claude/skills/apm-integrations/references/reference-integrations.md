...
| messaging | `rq/patch.py`, `kafka/patch.py`, `aiokafka/patch.py`, `kombu/patch.py` | -- | RQ and Kombu use shared messaging events; Kafka and aiokafka layer Kafka-specific events over the shared messaging lifecycle |
