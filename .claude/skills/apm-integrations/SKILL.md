...
description: |
  ...
  "uv", "test-env", "suitespec", "new integration", "wrap", "unwrap".
---
...
5. **Write tests** -- Add the component and dependency matrix to suitespec, generate locks with `scripts/test-env lock`, and add test files
