...
You need a Python version manager to install and manage multiple Python versions (3.9-3.14).
...
dd-trace-py supports Python 3.9 through 3.14. Install the versions you need for development:
...
pyenv install 3.14.0      # Latest 3.14.x

# Set local Python versions for the project
cd /path/to/dd-trace-py
pyenv local 3.14.0 3.13.9 3.12.12 3.11.14 3.10.19 3.9.24
...
**Recommended**: Install 3.10, 3.12, 3.13, and 3.14 as minimum for effective testing.
...
**IMPORTANT**: For most development workflows, you should use `scripts/run-tests` as your main entrypoint. 
This script automatically manages virtual environments, dependencies, and test execution. 
The manual dependency installation steps below are primarily for expert users who need fine-grained control
over their development environment or are troubleshooting specific issues.
...
uv python install 3.14                     # Install Python (uv)
pyenv install 3.14.0                       # Install Python (pyenv)
pyenv local 3.14.0                         # Set project Python (pyenv)
```
