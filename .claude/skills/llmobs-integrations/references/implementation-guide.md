...
| Tool-only spans | `openai.py` | OpenAI Responses API MCP tool calls create child tool spans; see `_ResponseHook._create_mcp_tool_span()` and `tests/contrib/openai/test_openai_llmobs.py` |
