...
use ddcommon::tracer_metadata::{AnonymousFileHandle, TracerMetadata, store_tracer_metadata};
...
pub fn store_metadata(data: &PyTracerMetadata) -> PyResult<PyAnonymousFileHandle> {
    let metadata = TracerMetadata {
        ...
        tracer_language: data.tracer_language.clone(),
