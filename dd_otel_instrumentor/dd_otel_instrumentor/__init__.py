"""
dd_otel_instrumentor - Datadog integrations compatible with OpenTelemetry SDK.

This package provides Datadog's integration instrumentation that works with
OpenTelemetry SDK instead of the Datadog tracer.

Usage:
    from dd_otel_instrumentor import patch
    patch("httpx")

    # Or patch multiple integrations
