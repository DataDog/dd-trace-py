...
traceback_exception_original_format_exception_only = traceback.TracebackException.format_exception_only
traceback_exception_format_syntax_error = getattr(traceback.TracebackException, "_format_syntax_error", None)
if sys.excepthook is sys.__excepthook__:
    traceback.TracebackException.__init__ = PatchedTracebackException.__init__  # type: ignore[assignment]
    traceback.TracebackException.format = PatchedTracebackException.format  # type: ignore[assignment]
...
def format_exception_only(__exc: BaseException) -> List[str]:
    return list(PatchedTracebackException(type(__exc), __exc, None, compact=True).format_exception_only())
...
def format_exception(
    ...
    return list(
        PatchedTracebackException(type(__exc), __exc, __exc.__traceback__, limit=limit, compact=True).format(
            chain=chain
        )
    )
...
def print_exception(
    ...
    for line in PatchedTracebackException(type(__exc), __exc, __exc.__traceback__, limit=limit).format(chain=chain):
