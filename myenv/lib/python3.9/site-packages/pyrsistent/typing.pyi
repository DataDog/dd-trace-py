...
class InvariantException(Exception):
    ...
    def __init__(self, error_codes: Any = ..., missing_fields: Any = ..., *args: Any, **kwargs: Any) -> None: ...
...
class CheckedTypeError(TypeError):
    ...
    actual_value: Any
    def __init__(
        self, source_class: Any, expected_types: Any, actual_type: Any, actual_value: Any, *args: Any, **kwargs: Any
    ) -> None: ...
...
class PTypeError(TypeError):
    ...
    actual_type: Type[Any] = ...
    def __init__(
        self, source_class: Any, field: Any, expected_types: Any, actual_type: Any, *args: Any, **kwargs: Any
    ) -> None: ...
