...
svmem = namedtuple(
    "svmem",
    ["total", "available", "percent", "used", "free", "active", "inactive", "buffers", "cached", "shared", "wired"],
)
# psutil.cpu_times()
...
class Process(object):
    ...
    def num_ctx_switches(self):
        ...
        return _common.pctxsw(
            rawtuple[kinfo_proc_map["ctx_switches_vol"]], rawtuple[kinfo_proc_map["ctx_switches_unvol"]]
        )
    ...
    def io_counters(self):
        rawtuple = self.oneshot()
        return _common.pio(
            rawtuple[kinfo_proc_map["read_io_count"]], rawtuple[kinfo_proc_map["write_io_count"]], -1, -1
        )
