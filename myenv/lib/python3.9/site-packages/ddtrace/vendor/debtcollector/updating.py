...
_KWARG_UPDATED_POSTFIX_TPL = ", please update the code to explicitly set %s " "as the value"
_KWARG_UPDATED_PREFIX_TPL = "The %s argument is changing its default value " "to %s"


def updated_kwarg_default_value(
    name, old_value, new_value, message=None, version=None, stacklevel=3, category=FutureWarning
):
