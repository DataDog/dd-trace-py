...
class IterableValidationNote(str):
    ...
    def __new__(cls, string: str, index: Union[int, str], type: Any) -> "IterableValidationNote":
...
class ForbiddenExtraKeysError(Exception):
    ...
    def __init__(self, message: Optional[str], cl: Type, extra_fields: Set[str]) -> None:
        ...
        msg = message if message else f"Extra fields in constructor for {cl.__name__}: {', '.join(extra_fields)}"
