...
if is_py37 or is_py38:
    ...
    def is_typeddict(cls) -> bool:
        return (
            ...
            or (
                ...
                or (is_generic(cls) and (cls.__origin__.__class__ is ExtensionsTypedDictMeta))
            )
        )
    ...
    def is_generic(obj) -> bool:
        return isinstance(obj, _GenericAlias) or isinstance(obj, GenericAlias) or is_subclass(obj, Generic)
