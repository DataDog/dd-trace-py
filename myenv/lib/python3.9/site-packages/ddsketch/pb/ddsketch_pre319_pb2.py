...
_INDEXMAPPING_INTERPOLATION = _descriptor.EnumDescriptor(
    ...
    values=[
        ...
        _descriptor.EnumValueDescriptor(name="LINEAR", index=1, number=1, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="QUADRATIC", index=2, number=2, options=None, type=None),
        _descriptor.EnumValueDescriptor(name="CUBIC", index=3, number=3, options=None, type=None),
    ],
...
_STORE.fields_by_name["contiguousBinCounts"]._options = _descriptor._ParseOptions(
