...
TestDraft4 = DRAFT4.to_unittest_testcase(
    ...
    skip=lambda test: (
        ...
        or skip(
            message=bug(),
            subject="ref",
            case_description=("id must be resolved against nearest parent, " "not just immediate parent"),
        )(test)
    ),
)
...
TestDraft201909 = DRAFT201909.to_unittest_testcase(
    ...
    skip=lambda test: (
        skip(
            ...
            case_description=("$recursiveRef with no $recursiveAnchor in " "the initial target schema resource"),
        ...
        or skip(
            message="recursiveRef support isn't working yet.",
            subject="recursiveRef",
            case_description=("dynamic $recursiveRef destination (not predictable " "at schema compile time)"),
...
TestDraft202012 = DRAFT202012.to_unittest_testcase(
    ...
    skip=lambda test: (
        ...
        or skip(
            ...
            case_description=("$ref and $dynamicAnchor are independent of order - " "$defs first"),
        )(test)
        or skip(
            message="dynamicRef support isn't fully working yet.",
            subject="dynamicRef",
        ...
        or skip(
            ...
            subject="dynamicRef",
            description="correct extended schema",
            case_description=("$ref and $dynamicAnchor are independent of order - $ref first"),
        )(test)
        or skip(
            message="dynamicRef support isn't fully working yet.",
            subject="dynamicRef",
