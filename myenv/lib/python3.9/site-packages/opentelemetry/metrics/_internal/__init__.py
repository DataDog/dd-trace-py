...
from opentelemetry.metrics._internal.instrument import _ProxyHistogram
from opentelemetry.metrics._internal.instrument import _ProxyObservableCounter
from opentelemetry.metrics._internal.instrument import _ProxyObservableGauge
from opentelemetry.metrics._internal.instrument import _ProxyObservableUpDownCounter
from opentelemetry.metrics._internal.instrument import _ProxyUpDownCounter
...
class NoOpMeter(Meter):
    ...
    def create_observable_counter(
        ...
        super().create_observable_counter(name, callbacks, unit=unit, description=description)
    ...
    def create_observable_gauge(
        ...
        super().create_observable_gauge(name, callbacks, unit=unit, description=description)
    ...
    def create_observable_up_down_counter(
        ...
        super().create_observable_up_down_counter(name, callbacks, unit=unit, description=description)
