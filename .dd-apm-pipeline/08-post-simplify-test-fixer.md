...
<!-- Workflow: execute, Namespace: pyramid, Step: fixer -->

# Test Fixer Agent - Iteration <derive from repository or prior step: iteration>

## Mission

Fix the failing integration tests for **pyramid** (version: **<derive from repository or prior step: package_version>**) based on the diagnosis below.
...
Always use `scripts/run-tests tests/contrib/pyramid/` -- never `pytest` directly.
