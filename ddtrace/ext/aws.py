...
# TODO: We should deprecate the legacy exclusion list
...
def _add_api_param_span_tags(span, endpoint_name, params):
    ...
    elif endpoint_name == "eventbridge":
        # FIXME: dd-trace-js uses Params["Source"] whereas we use Params["Entries"]["Source"]
        entries = params.get("Entries")
        if entries:
            source = entries.get("Source")
            if source:
                span.set_tag_str("aws.eventbridge.source", source)
