...
def _get_item_tag(item_id: TestVisibilityItemId, tag_name: str) -> Any:
    ...
    tag_value = core.dispatch_with_results(
        "ci_visibility.item.get_tag", (_TestVisibilityAPIBase.GetTagArgs(item_id, tag_name),)
    ).tag_value.value
    return tag_value
...
def _set_item_tag(item_id: TestVisibilityItemId, tag_name: str, tag_value: Any, recurse: bool = False):
    ...
    core.dispatch("ci_visibility.item.set_tag", (_TestVisibilityAPIBase.SetTagArgs(item_id, tag_name, tag_value),))
...
def _set_item_tags(item_id: TestVisibilityItemId, tags: Dict[str, Any], recurse: bool = False):
    ...
    core.dispatch("ci_visibility.item.set_tags", (_TestVisibilityAPIBase.SetTagsArgs(item_id, tags),))
...
def _delete_item_tag(item_id: TestVisibilityItemId, tag_name: str, recurse: bool = False):
    ...
    core.dispatch("ci_visibility.item.delete_tag", (_TestVisibilityAPIBase.DeleteTagArgs(item_id, tag_name),))
...
def _delete_item_tags(item_id: TestVisibilityItemId, tag_names: List[str], recurse: bool = False):
    ...
    core.dispatch("ci_visibility.item.delete_tags", (_TestVisibilityAPIBase.DeleteTagsArgs(item_id, tag_names),))
