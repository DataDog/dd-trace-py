...
class APIManager(Service):
    ...
    def _schema_callback(self, env):
        ...
        try:
            ...
            if root._context.sampling_priority is None and env.span._context.sampling_priority is None:
                priorities = (1,)
            else:
                priorities = (root._context.sampling_priority or 0, env.span._context.sampling_priority or 0)
