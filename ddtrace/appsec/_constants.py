...
class SPAN_DATA_NAMES(metaclass=Constant_Class):
    ...
    REQUEST_PATH_PARAMS: Literal["http.request.path_params"] = "http.request.path_params"
    ...
    RESPONSE_HEADERS_NO_COOKIES: Literal["http.response.headers"] = "http.response.headers"
