...
def iast_ast_debug_log(msg, *args, **kwargs):
    iast_instrumentation_ast_patching_debug_log(("ast::%s" % msg), *args, **kwargs)


def iast_compiling_debug_log(msg, *args, **kwargs):
    iast_instrumentation_ast_patching_debug_log(("compiling::%s" % msg), *args, **kwargs)
...
def iast_propagation_log_log(msg, *args, **kwargs):
