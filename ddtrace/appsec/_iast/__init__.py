...
def _iast_pytest_activation():
    ...
    _env.environ["DD_IAST_REQUEST_SAMPLING"] = _env.environ.get("DD_IAST_REQUEST_SAMPLING") or "100.0"
    _env.environ["_DD_APPSEC_DEDUPLICATION_ENABLED"] = _env.environ.get("_DD_APPSEC_DEDUPLICATION_ENABLED") or "false"
    _env.environ["DD_IAST_VULNERABILITIES_PER_REQUEST"] = _env.environ.get("DD_IAST_VULNERABILITIES_PER_REQUEST") or "1000"
