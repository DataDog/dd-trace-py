...
def copy_ranges_to_string(s: str, ranges: Iterable[TaintRange]) -> str:
    for r in ranges:
...
def copy_ranges_to_iterable_with_strings(iterable: Iterable[str], ranges: Iterable[TaintRange]) -> Iterable[str]:
