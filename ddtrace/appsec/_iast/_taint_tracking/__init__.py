...
if _is_python_version_supported():
    ...
    from ddtrace.appsec._iast._taint_tracking._native.aspect_helpers import as_formatted_evidence
    from ddtrace.appsec._iast._taint_tracking._native.aspect_helpers import common_replace
    from ddtrace.appsec._iast._taint_tracking._native.aspect_helpers import parse_params
    from ddtrace.appsec._iast._taint_tracking._native.initializer import active_map_addreses_size
    from ddtrace.appsec._iast._taint_tracking._native.initializer import contexts_reset
    from ddtrace.appsec._iast._taint_tracking._native.initializer import create_context
    from ddtrace.appsec._iast._taint_tracking._native.initializer import destroy_context
    from ddtrace.appsec._iast._taint_tracking._native.initializer import get_context
    from ddtrace.appsec._iast._taint_tracking._native.initializer import initializer_size
    from ddtrace.appsec._iast._taint_tracking._native.initializer import num_contexts
    from ddtrace.appsec._iast._taint_tracking._native.initializer import num_objects_tainted
    ...
    from ddtrace.appsec._iast._taint_tracking._native.taint_tracking import TagMappingMode
    from ddtrace.appsec._iast._taint_tracking._native.taint_tracking import are_all_text_all_ranges
    from ddtrace.appsec._iast._taint_tracking._native.taint_tracking import get_range_by_hash
    ...
    from ddtrace.appsec._iast._taint_tracking._native.taint_tracking import is_tainted
    from ddtrace.appsec._iast._taint_tracking._native.taint_tracking import origin_to_str
