...
#
# This needs to be an target to it is included after the local pybind11 directory, just in case there are multiple
# versions of pybind11, we want the one we expect.
...
# The IMPORTED INTERFACE library here is to ensure that "debug" and "release" get processed outside of a generator
# expression - https://gitlab.kitware.com/cmake/cmake/-/issues/18424, as they are target_link_library keywords rather
# than real libraries.
...
target_link_libraries(pybind11::embed INTERFACE pybind11::pybind11 pybind11::_ClassicPythonLibraries)
...
# Build a Python extension module: pybind11_add_module(<name> [MODULE | SHARED] [EXCLUDE_FROM_ALL] [NO_EXTRAS]
# [THIN_LTO] [OPT_SIZE] source1 [source2 ...])
#
