...
{
    m.def("common_replace", &api_common_replace<py::bytes>, "string_method"_a, "candidate_text"_a, py::return_value_policy::move);
    m.def("common_replace", &api_common_replace<py::str>, "string_method"_a, "candidate_text"_a, py::return_value_policy::move);
    m.def("common_replace", &api_common_replace<py::bytearray>, "string_method"_a, "candidate_text"_a, py::return_value_policy::move);
    ...
    m.def("_convert_escaped_text_to_tainted_text",
          ...
          "ranges_orig"_a, py::return_value_policy::move);
    m.def("_convert_escaped_text_to_tainted_text",
