...
def stringio_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> _io.StringIO:
    ...
    if args and is_pyobject_tainted(args[0]) and isinstance(result, _io.StringIO):
        try:
            ...
            iast_propagation_error_log("IAST propagation error. stringio_aspect. {}".format(e))
    return result
...
def bytesio_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> _io.BytesIO:
    ...
    if args and is_pyobject_tainted(args[0]) and isinstance(result, _io.BytesIO):
        try:
            ...
            iast_propagation_error_log("IAST propagation error. bytesio_aspect. {}".format(e))
    return result
...
def bytes_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> bytes:
    ...
    if args and is_pyobject_tainted(args[0]):
        try:
            ...
            iast_propagation_error_log("bytes_aspect. {}".format(e))
    return result
...
def bytearray_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> bytearray:
    ...
    if args and is_pyobject_tainted(args[0]):
        try:
            ...
            iast_propagation_error_log("bytearray_aspect. {}".format(e))
    return result
...
def bytearray_extend_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Any:
    ...
    try:
        ...
        iast_propagation_error_log("extend_aspect. {}".format(e))
...
def ljust_aspect(
    ...
    if isinstance(candidate_text, IAST.TEXT_TYPES):
        try:
            ...
            iast_propagation_error_log("ljust_aspect. {}".format(e))
...
def zfill_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("format_aspect. {}".format(e))
...
def format_map_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("format_map_aspect. {}".format(e))
...
def repr_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Any:
    ...
    if args and isinstance(args[0], IAST.TEXT_TYPES) and is_pyobject_tainted(args[0]):
        try:
            ...
            iast_propagation_error_log("repr_aspect. {}".format(e))
    return result
...
def format_value_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("format_value_aspect. {}".format(e))
        return new_text
...
def decode_aspect(
    ...
    if is_pyobject_tainted(self) and isinstance(self, bytes):
        try:
            ...
            iast_propagation_error_log("decode_aspect. {}".format(e))
    return result
...
def encode_aspect(
    ...
    if is_pyobject_tainted(self) and isinstance(self, str):
        try:
            ...
            iast_propagation_error_log("encode_aspect. {}".format(e))
...
def upper_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("upper_aspect. {}".format(e))
        return candidate_text.upper(*args, **kwargs)
...
def lower_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("lower_aspect. {}".format(e))
        return candidate_text.lower(*args, **kwargs)
...
def replace_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("replace_aspect. {}".format(e))
        return orig_result
...
def swapcase_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("swapcase_aspect. {}".format(e))
        return candidate_text.swapcase(*args, **kwargs)
...
def title_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("title_aspect. {}".format(e))
        return candidate_text.title(*args, **kwargs)
...
def capitalize_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("capitalize_aspect. {}".format(e))
        return candidate_text.capitalize(*args, **kwargs)
...
def casefold_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("casefold_aspect. {}".format(e))
...
def translate_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("translate_aspect. {}".format(e))
        return candidate_text.translate(*args, **kwargs)
...
def re_findall_aspect(
    ...
    try:
        ...
        iast_propagation_error_log("re_findall_aspect. {}".format(e))
...
def re_finditer_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Iterator:
    ...
    try:
        ...
        iast_propagation_error_log("IAST propagation error. re_finditer_aspect. {}".format(e))
    return result
...
def re_groups_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Any:
    ...
    try:
        ...
        iast_propagation_error_log("re_groups_aspect. {}".format(e))
        return result
...
def re_group_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Any:
    ...
    try:
        ...
        iast_propagation_error_log("re_group_aspect. {}".format(e))
...
def re_expand_aspect(orig_function: Optional[Callable], flag_added_args: int, *args: Any, **kwargs: Any) -> Any:
    ...
    try:
        ...
        iast_propagation_error_log("re_expand_aspect. {}".format(e))
