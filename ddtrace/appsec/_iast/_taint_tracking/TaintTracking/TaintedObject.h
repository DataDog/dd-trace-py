...
class TaintedObject
{
  ...
  public:
    ...
    void add_ranges_shifted(TaintedObject* tainted_object, RANGE_START offset, RANGE_LENGTH max_length = -1, RANGE_LENGTH orig_offset = -1);

    void add_ranges_shifted(TaintRangeRefs ranges, RANGE_START offset, RANGE_LENGTH max_length = -1, RANGE_LENGTH orig_offset = -1);
