...
static py::str format_traceback(PyObject* ptraceback, PyObject* exc_type, PyObject* exc_value) {
    ...
    try {
        ...
        std::string complete_traceback = "Traceback (most recent call last):\n" + tb_str.cast<std::string>() + exc_str.cast<std::string>();
...
PythonErrorGuard::PythonErrorGuard()
    : ptype(nullptr), pvalue(nullptr), ptraceback(nullptr), had_exception(false)
{
...
void PythonErrorGuard::restore_or_decref()
{
