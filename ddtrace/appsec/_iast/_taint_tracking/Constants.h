...
#define MSG_ERROR_SET_RANGES "iast::propagation::native::error::Set ranges error: Empty ranges or Tainted Map isn't initialized"
#define MSG_ERROR_GET_RANGES_TYPE "iast::propagation::native::error::Get ranges error: Invalid type of candidate_text variable"
