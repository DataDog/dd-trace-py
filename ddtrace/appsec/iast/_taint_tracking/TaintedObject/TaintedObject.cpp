...
void TaintedObject::add_ranges_shifted(TaintedObjectPtr tainted_object, long offset) {
...
void TaintedObject::incref() {
    rc_++;
}

void TaintedObject::decref() {
    if (--rc_ <= 0) {
        release();
    }
}

void TaintedObject::release() {
