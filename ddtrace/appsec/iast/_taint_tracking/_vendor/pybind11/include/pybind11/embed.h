...
inline wchar_t*
widen_chars(const char* safe_arg)
{
...
inline void
initialize_interpreter_pre_pyconfig(bool init_signal_handlers,
                                    int argc,
...
#if PY_VERSION_HEX >= PYBIND11_PYCONFIG_SUPPORT_PY_VERSION_HEX
inline void
initialize_interpreter(PyConfig* config,
                       int argc = 0,
                       ...
                       bool add_program_dir_to_path = true)
{
    ...
    if (PyStatus_Exception(status) != 0) {
        ...
        throw std::runtime_error(PyStatus_IsError(status) != 0 ? status.err_msg : "Failed to prepare CPython");
    }
...
/** \rst
 ...
 \endrst */
inline void
initialize_interpreter(bool init_signal_handlers = true,
                       int argc = 0,
                       const char* const* argv = nullptr,
                       bool add_program_dir_to_path = true)
{
