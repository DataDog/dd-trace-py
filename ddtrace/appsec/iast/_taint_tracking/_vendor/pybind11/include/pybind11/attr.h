...
inline void
check_kw_only_arg(const arg& a, function_record* r)
{
...
inline void
append_self_arg_if_needed(function_record* r)
{
...
constexpr bool
expected_num_args(size_t nargs, bool has_args, bool has_kwargs)
{
