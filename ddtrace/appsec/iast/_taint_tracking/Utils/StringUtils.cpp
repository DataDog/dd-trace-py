...
py::bytearray copy_string_new_id(const py::bytearray &source) { return source; }

py::object copy_string_new_id(const py::object &source) { return source; }
...
void pyexport_string_utils(py::module &m) {
  m.def("copy_string_new_id",
        py::overload_cast<const py::bytes &>(&copy_string_new_id), "s"_a,
        py::return_value_policy::move);
  m.def("copy_string_new_id",
        py::overload_cast<const py::str &>(&copy_string_new_id), "s"_a,
        py::return_value_policy::move);
  m.def("copy_string_new_id",
        py::overload_cast<const py::bytearray &>(&copy_string_new_id), "s"_a,
        py::return_value_policy::move);
  m.def("copy_string_new_id",
        py::overload_cast<const py::object &>(&copy_string_new_id), "s"_a,
        py::return_value_policy::move);
}
