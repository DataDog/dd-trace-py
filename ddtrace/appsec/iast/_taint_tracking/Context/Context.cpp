...
void pyexport_context(py::module& m) {
    py::class_<Context, shared_ptr<Context>>(m, "Context")
        ...
        .def("add_sent_blocking_vulnerability_hash", &Context::add_sent_blocking_vulnerability_hash, "vulnerability"_a,
             "analyzer_name"_a)
        .def("blocking_vulnerability_hash_already_sent", &Context::blocking_vulnerability_hash_already_sent,
             "vulnerability"_a, "analyzer_name"_a)
