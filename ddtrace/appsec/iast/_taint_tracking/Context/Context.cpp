...
void pyexport_context(py::module &m) {
  py::class_<Context, shared_ptr<Context>>(m, "Context")
      ...
      .def("set_propagation",
           py::overload_cast<bool>(&Context::set_propagation))
      .def("get_propagation", &Context::get_propagation)
      .def("add_sent_blocking_vulnerability_hash",
           &Context::add_sent_blocking_vulnerability_hash, "vulnerability"_a,
           "analyzer_name"_a)
      ...
      .def("reset_blocking_vulnerability_hashes",
           &Context::reset_blocking_vulnerability_hashes);
};
Context::Context() {}
