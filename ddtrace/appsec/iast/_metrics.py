...
def _set_metric_iast_instrumented_propagation():
    telemetry_lifecycle_writer.add_count_metric(TELEMETRY_NAMESPACE_TAG_IAST, "instrumented.propagation", 1)
...
def _set_metric_iast_request_tainted():
    telemetry_lifecycle_writer.add_count_metric(TELEMETRY_NAMESPACE_TAG_IAST, "request.tainted", 1)
