...
def enable_appsec_rc():
    ...
    if _appsec_rc_features_is_enabled():
        ...
        remoteconfig_poller.register(PRODUCTS.ASM_FEATURES, appsec_callback)

    if tracer._appsec_enabled:
        from ddtrace.internal.remoteconfig import remoteconfig_poller

        remoteconfig_poller.register(PRODUCTS.ASM_DATA, appsec_callback)  # IP Blocking
        remoteconfig_poller.register(PRODUCTS.ASM, appsec_callback)  # Exclusion Filters & Custom Rules
        remoteconfig_poller.register(PRODUCTS.ASM_DD, appsec_callback)  # DD Rules
