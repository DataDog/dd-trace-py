...
def _openai_chat_completion_before(client, kwargs):
    ...
    evaluate_messages(client, ai_guard_messages, _get_openai_abort_error_cls(), "OpenAI chat completion request")
    return None
...
def _openai_chat_completion_after(client, kwargs, resp):
    ...
    evaluate_messages(client, all_messages, _get_openai_abort_error_cls(), "OpenAI chat completion response")
    return None
