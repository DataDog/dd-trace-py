...
class _DBM_Propagator(object):
    def __init__(
        self,
        sql_pos,  # Skip complex typing to avoid dependency complexity
        sql_kw,  # Skip complex typing to avoid dependency complexity
        comment_injector=default_sql_injector,  # Skip complex typing for callable
        comment_generator=_generate_sql_comment,  # Skip complex typing for callable
    ...
    def inject(self, dbspan, args, kwargs):  # Skip complex typing for span and args/kwargs
...
def handle_dbm_injection(int_config, span, args, kwargs):  # Skip complex typing for integration config and span
...
def handle_dbm_injection_asyncpg(
    int_config, method, span, args, kwargs
):  # Skip complex typing for integration config and span
