...
# access — not at ``from ddtrace.aiguard import AIGuardAbortError`` time.
...
# ``ddtrace.aiguard.integrations``; this module only re-exports it.
# Regression test: tests/aiguard/strands_hooks/test_strands.py::TestLazyImport.
