...
def _ddmap(span: DDSpan, attribute: str, value: Union[str, bytes, NumericType]) -> DDSpan:
...
class Span(OtelSpan):
    ...
    def _datadog_operation_name(self):
        # Adapted from
        # https://github.com/DataDog/dd-trace-java/blob/4131e509a94db430b47104769800ec14f0a0d/
        # dd-java-agent/instrumentation/opentelemetry/opentelemetry-1.4/src/main/java/datadog/trace/
        # instrumentation/opentelemetry14/trace/OtelConventions.java#L107
        ddspan = self._ddspan
        span_kind = self.kind
