...
import threading
from typing import Mapping, Optional, Sequence, Tuple, Union, MutableMapping
...
def _clean_attribute(
    key: str, value: AttributeValue, max_len: Optional[int]
) -> Optional[Union[AttributeValue, Tuple[Union[str, int, float], ...]]]:
...
def _clean_extended_attribute_value(
    value: AnyValue, max_len: Optional[int]
) -> AnyValue:
    ...
    if isinstance(value, Mapping):
        cleaned_dict: dict[str, AnyValue] = {}
...
def _clean_extended_attribute(
    key: str, value: AnyValue, max_len: Optional[int]
) -> AnyValue:
    """Checks if attribute value is valid and cleans it if required.
...
def _clean_attribute_value(
    value: AttributeValue, limit: Optional[int]
