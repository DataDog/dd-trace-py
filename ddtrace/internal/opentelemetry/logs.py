...
def _initialize_logging(exporter_class, protocol, resource):
    ...
    try:
        ...
        if "OTEL_EXPORTER_OTLP_ENDPOINT" not in _environ and "OTEL_EXPORTER_OTLP_LOGS_ENDPOINT" not in _environ:
            _environ["OTEL_EXPORTER_OTLP_LOGS_ENDPOINT"] = otel_config.exporter.LOGS_ENDPOINT
