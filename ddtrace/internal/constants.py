"""
This module contains constants internal to ddtrace. These constants are not exposed to ddtrace users.
"""
...
PROPAGATION_STYLE_W3C_TRACECONTEXT = "tracecontext"
PROPAGATION_STYLE_NONE = "none"
PROPAGATION_STYLE_DEFAULT = "datadog,tracecontext,baggage"
...
PROPAGATION_BEHAVIOR_DEFAULT = PROPAGATION_BEHAVIOR_CONTINUE
...
SINGLE_SPAN_SAMPLING_MAX_PER_SEC_NO_LIMIT = -1
...
APM_ENABLED_METRIC_KEY = "_dd.apm.enabled"
...
DJM_ENABLED_KEY = "_dd.djm.enabled"
FILTER_KEPT_KEY = "_dd.filter.kept"
...
KEEP_PRIORITY_INDEX = 0
REJECT_PRIORITY_INDEX = 1
