"""
This file contains shared utilities for tracing streams. Integrations should implement a
StreamHandler and / or AsyncStreamHandler subclass to be passed into the make_traced_stream
