...
def collect() -> dict[str, Any]:
    ...
    return dict(
        ...
        otlp_traces_export_enabled=agent_config.trace_otlp_export_enabled,
        otlp_metrics_export_enabled=ddtrace.config._otel_metrics_enabled,
        otlp_logs_export_enabled=ddtrace.config._otel_logs_enabled,
