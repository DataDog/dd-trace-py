...
extern "C"
{
    ...
    void ddup_profile_set_endpoints(const std::unordered_map<int64_t, std::string_view>& span_ids_to_endpoints);
    void ddup_profile_add_endpoint_counts(const std::unordered_map<std::string_view, int64_t>& trace_endpoints_to_counts);
    bool ddup_upload();
