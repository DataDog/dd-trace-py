...
// This is the shared state for all Profile objects  It should be marked as
// as static in the Profile object.
class ProfileSharedState
{
  private:
  ...
  public:
    void one_time_init(ProfileType type, unsigned int _max_nframes);
    void setup_samplers();
    bool cycle_buffers();
    ...
    // Flush
    bool flush_sample(ddog_prof_Sample& sample);
