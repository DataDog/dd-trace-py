...
class Sample
{
  ...
  public:
    ...
    std::optional<function_id> push_frame_impl(std::string_view name, std::string_view filename, uint64_t address, int64_t line);
    ...
    std::optional<function_id> push_frame(std::string_view name, std::string_view filename, uint64_t address, int64_t line);
