...
Datadog::ProfilerStats::add_gc_snapshot_timing(const GCSnapshotTiming& t)
{
    ...
    gc_name_resolve_time_us += t.name_resolve_us;
...
Datadog::ProfilerStats::get_internal_metadata_json()
{
    ...
    internal_metadata_json += R"("gc_name_resolve_time_us": )";
    append_to_string(internal_metadata_json, gc_name_resolve_time_us);
    internal_metadata_json += ",";
