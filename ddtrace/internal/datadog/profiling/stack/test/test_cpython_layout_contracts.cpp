...
static_assert(FRAME_OWNED_BY_THREAD == 0,
              "TODO(py-315): _frameowner::FRAME_OWNED_BY_THREAD changed value — update frame.cc owner switch");
static_assert(FRAME_OWNED_BY_GENERATOR == 1,
              "TODO(py-315): _frameowner::FRAME_OWNED_BY_GENERATOR changed value — update frame.cc owner switch");
static_assert(FRAME_OWNED_BY_FRAME_OBJECT == 2,
              "TODO(py-315): _frameowner::FRAME_OWNED_BY_FRAME_OBJECT changed value — update frame.cc owner switch");
static_assert(FRAME_OWNED_BY_CSTACK == 3,
              "TODO(py-315): _frameowner::FRAME_OWNED_BY_CSTACK changed value — update frame.cc owner switch");
...
static_assert(FRAME_OWNED_BY_INTERPRETER == 3,
              "TODO(py-315): _frameowner::FRAME_OWNED_BY_INTERPRETER changed value — update frame.cc owner switch");
...
static_assert(FRAME_CREATED == -2,
              "TODO(py-315): PyFrameState::FRAME_CREATED changed value — update tasks.h PyGen_yf and tasks.cc");
static_assert(FRAME_SUSPENDED == -1, "TODO(py-315): PyFrameState::FRAME_SUSPENDED changed value");
static_assert(FRAME_EXECUTING == 0,
              "TODO(py-315): PyFrameState::FRAME_EXECUTING changed value — update tasks.cc gen_is_running check");
// FRAME_COMPLETED == 1 is not used by echion directly; omitted intentionally.
static_assert(FRAME_CLEARED == 4,
              "TODO(py-315): PyFrameState::FRAME_CLEARED changed value — update tasks.cc gi_frame_state check");
...
static_assert(FRAME_CREATED == -3,
              "TODO(py-315): PyFrameState::FRAME_CREATED changed value — update tasks.h PyGen_yf and tasks.cc");
static_assert(FRAME_SUSPENDED == -2, "TODO(py-315): PyFrameState::FRAME_SUSPENDED changed value");
static_assert(FRAME_SUSPENDED_YIELD_FROM == -1,
              "TODO(py-315): PyFrameState::FRAME_SUSPENDED_YIELD_FROM changed value — update tasks.h PyGen_yf");
static_assert(FRAME_EXECUTING == 0,
              "TODO(py-315): PyFrameState::FRAME_EXECUTING changed value — update tasks.cc gen_is_running check");
// FRAME_COMPLETED == 1 is not used by echion directly; omitted intentionally.
static_assert(FRAME_CLEARED == 4,
...
static_assert(
  ...
  "TODO(py-315): FRAME_SUSPENDED_YIELD_FROM_LOCKED changed value — update tasks.h PyGen_yf (Py_GIL_DISABLED)");
#endif
