...
// they belong to the loaded file; macOS parses bounded syscall snapshots of Mach-O metadata without dereferencing
// borrowed dyld pointers. Missing metadata omits native task-list
