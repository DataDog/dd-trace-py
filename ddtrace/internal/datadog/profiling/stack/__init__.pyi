...
def register_logical_span_provider(provider: Callable[[], Optional[int]], priority: int = 0) -> None: ...
def unregister_logical_span_provider(provider: Callable[[], Optional[int]]) -> None: ...
def link_span(span: Optional[Union[context.Context, ddspan.Span]]) -> None: ...
def link_logical_span(logical_id: int, span: Optional[Union[context.Context, ddspan.Span]]) -> None: ...
def link_logical_span_context(logical_id: int, task_context: Optional[contextvars.Context] = None) -> bool: ...
