...
def link_span(span_id: int, local_root_span_id: int, span_type: Optional[str] = None) -> None: ...
...
def unlink_task_span(task_id: int, expected_span_id: int) -> None: ...
def link_greenlet_span(
    greenlet_id: int,
    span_id: int,
    local_root_span_id: int,
    span_type: Optional[str],
...
def unlink_greenlet_span(greenlet_id: int, expected_span_id: int) -> None: ...
