...
static PyObject*
stack_set_max_threads_per_cycle(PyObject* Py_UNUSED(self), PyObject* args)
{
    ...
    Sampler::get().set_max_threads_per_cycle(max_threads);
...
static PyMethodDef stack_methods[] = {
    ...
    { "set_max_threads_per_cycle",
      stack_set_max_threads_per_cycle,
      METH_VARARGS,
      "Set max threads to sample per cycle for thread sub-sampling" },
