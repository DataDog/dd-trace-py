...
_IMPORT_NAME_ARG_SHIFT = 2 if sys.version_info >= CURRENT_MAX_PY_VERSION else 0
...
_USE_ACCURATE_IMPORTS = sys.version_info < CURRENT_MAX_PY_VERSION and _ACCURATE_IMPORTS_REQUESTED
