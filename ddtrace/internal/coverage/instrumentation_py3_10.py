...
def _get_offsets_to_instrument(injection_context) -> t.List[int]:
    ...
    1. The first executable line (after RESUME) - to track that the module was loaded
    ...
    line_starts_dict = dict(line_starts)
    ...
    # Find the first offset after RESUME
    first_offset = None
    ...
    if first_offset is None:
        # Fallback: use the minimum offset
        first_offset = min(o for o, _ in line_starts)
    ...
    return sorted(offsets_to_instrument)
