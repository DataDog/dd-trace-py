...
class ATRSessionMixin:
    ...
    def atr_is_enabled() -> bool:
        ...
        core.dispatch("test_visibility.atr.is_enabled")
        is_enabled = core.get_item("test_visibility.atr.is_enabled")
    ...
    def atr_has_failed_tests() -> bool:
        ...
        core.dispatch("test_visibility.atr.session_has_failed_tests")
        has_failed_tests = core.get_item("test_visibility.atr.session_has_failed_tests")
...
class ATRTestMixin:
    ...
    def atr_should_retry(item_id: InternalTestId) -> bool:
        ...
        core.dispatch("test_visibility.atr.should_retry_test", (item_id,))
        should_retry_test = core.get_item(f"test_visibility.atr.should_retry_test.{item_id}")
    ...
    def atr_add_retry(item_id: InternalTestId, start_immediately: bool = False) -> int:
        ...
        core.dispatch("test_visibility.atr.add_retry", (item_id, start_immediately))
        retry_number = core.get_item(f"test_visibility.atr.add_retry.{item_id}")
    ...
    def atr_get_final_status(item_id: InternalTestId) -> ext_api.TestStatus:
        ...
        core.dispatch("test_visibility.atr.get_final_status", (item_id,))
        atr_final_status = core.get_item(f"test_visibility.atr.get_final_status.{item_id}")
