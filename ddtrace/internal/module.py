...
_run_code = None
_run_module_transformers: t.List[TransformerType] = []  # noqa: UP006
_post_run_module_hooks: t.List[ModuleHookType] = []  # noqa: UP006


def _wrapped_run_code(*args: t.Any, **kwargs: t.Any) -> t.Dict[str, t.Any]:  # noqa: UP006
...
class _ImportHookChainedLoader:
    def __init__(self, loader: t.Optional["Loader"], spec: t.Optional[ModuleSpec] = None) -> None:
        ...
        self.callbacks: t.Dict[t.Any, t.Callable[[ModuleType], None]] = {}  # noqa: UP006
        self.import_exception_callbacks: t.Dict[t.Any, t.Callable[[ModuleType], None]] = {}  # noqa: UP006

        self.transformers: t.Dict[t.Any, TransformerType] = {}  # noqa: UP006
...
class BaseModuleWatchdog(abc.ABC):
    ...
    def __init__(self) -> None:
        self._finding: t.Set[str] = set()  # noqa: UP006
...
class ModuleWatchdog(BaseModuleWatchdog):
    ...
    def __init__(self) -> None:
        ...
        self._hook_map: t.DefaultDict[str, t.List[ModuleHookType]] = defaultdict(list)  # noqa: UP006
        ...
        self._pre_exec_module_hooks: t.Set[t.Tuple[PreExecHookCond, PreExecHookType]] = set()  # noqa: UP006
        self._import_exception_hooks: t.Set[t.Tuple[ImportExceptionHookCond, ImportExceptionHookType]] = set()  # noqa: UP006
    ...
    def register_pre_exec_module_hook(
        cls: t.Type["ModuleWatchdog"],  # noqa: UP006
        cond: PreExecHookCond,
        hook: PreExecHookType,
    ) -> None:
    ...
    def register_import_exception_hook(
        cls: t.Type["ModuleWatchdog"],  # noqa: UP006
        cond: ImportExceptionHookCond,
        hook: ImportExceptionHookType,
    ):
        cls.install()
