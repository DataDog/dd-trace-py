...
from ...internal.core import crashtracker
...
from .constants import TELEMETRY_CRASHTRACKER_ALT_STACK
from .constants import TELEMETRY_CRASHTRACKER_AVAILABLE
from .constants import TELEMETRY_CRASHTRACKER_DEBUG_URL
from .constants import TELEMETRY_CRASHTRACKER_ENABLED
from .constants import TELEMETRY_CRASHTRACKER_STACKTRACE_RESOLVER
from .constants import TELEMETRY_CRASHTRACKER_STARTED
from .constants import TELEMETRY_CRASHTRACKER_STDERR_FILENAME
from .constants import TELEMETRY_CRASHTRACKER_STDOUT_FILENAME
    ...
    def _app_started_event(self, register_app_shutdown=True):
        ...
        self.add_configurations(
            [
                ...
                # Crashtracker
                (TELEMETRY_CRASHTRACKER_ENABLED, crashtracker_config.enabled, "unknown"),
                (TELEMETRY_CRASHTRACKER_STARTED, crashtracker.is_started(), "unknown"),
                (TELEMETRY_CRASHTRACKER_AVAILABLE, crashtracker.is_available, "unknown"),
                (TELEMETRY_CRASHTRACKER_STACKTRACE_RESOLVER, str(crashtracker_config.stacktrace_resolver), "unknown"),
                (TELEMETRY_CRASHTRACKER_STDOUT_FILENAME, str(crashtracker_config.stdout_filename), "unknown"),
                (TELEMETRY_CRASHTRACKER_STDERR_FILENAME, str(crashtracker_config.stderr_filename), "unknown"),
                (TELEMETRY_CRASHTRACKER_DEBUG_URL, str(crashtracker_config.debug_url), "unknown"),
                (TELEMETRY_CRASHTRACKER_ALT_STACK, crashtracker_config.alt_stack, "unknown"),
            ]
