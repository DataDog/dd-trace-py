...
_ANCESTOR_RUNTIME_ID: t.Optional[str] = os.environ.get(_ENV_ROOT_SESSION_ID) or None
_PARENT_RUNTIME_ID: t.Optional[str] = os.environ.get(_ENV_PARENT_SESSION_ID) or None
