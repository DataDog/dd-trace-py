...
# -----------------------------------------------------------------------------
# libddwaf bindings (appsec WAF). One-for-one mirror of the libddwaf C ABI; all
# orchestration/build/read logic lives on the Python side (ddtrace/appsec/_ddwaf).
# -----------------------------------------------------------------------------

class ddwaf:
    """Native libddwaf bindings; libddwaf is statically linked into the extension."""

    class DDWafAllocator:
        """Opaque handle to the libddwaf default allocator (process-wide singleton)."""

    class DDWafObject:
        """Opaque wrapper around a raw ``ddwaf_object`` (an owned struct or a slot view)."""

        def __new__(cls) -> "ddwaf.DDWafObject": ...
        @property
        def type(self) -> int: ...
        def __bool__(self) -> bool: ...
    ...
    @staticmethod
    def ddwaf_get_default_allocator() -> "ddwaf.DDWafAllocator": ...
    @staticmethod
    def ddwaf_get_version() -> str: ...
    @staticmethod
    def ddwaf_object_set_string(
        obj: "ddwaf.DDWafObject", string: bytes, length: int, alloc: "ddwaf.DDWafAllocator"
    ) -> None: ...
    @staticmethod
    def ddwaf_object_set_signed(obj: "ddwaf.DDWafObject", value: int) -> None: ...
    @staticmethod
    def ddwaf_object_set_unsigned(obj: "ddwaf.DDWafObject", value: int) -> None: ...
    @staticmethod
    def ddwaf_object_set_bool(obj: "ddwaf.DDWafObject", value: bool) -> None: ...
    @staticmethod
    def ddwaf_object_set_float(obj: "ddwaf.DDWafObject", value: float) -> None: ...
    @staticmethod
    def ddwaf_object_set_null(obj: "ddwaf.DDWafObject") -> None: ...
    @staticmethod
    def ddwaf_object_set_array(obj: "ddwaf.DDWafObject", capacity: int, alloc: "ddwaf.DDWafAllocator") -> None: ...
    @staticmethod
    def ddwaf_object_set_map(obj: "ddwaf.DDWafObject", capacity: int, alloc: "ddwaf.DDWafAllocator") -> None: ...
    @staticmethod
    def ddwaf_object_insert(obj: "ddwaf.DDWafObject", alloc: "ddwaf.DDWafAllocator") -> "ddwaf.DDWafObject": ...
    @staticmethod
    def ddwaf_object_insert_key(
        obj: "ddwaf.DDWafObject", key: bytes, length: int, alloc: "ddwaf.DDWafAllocator"
    ) -> "ddwaf.DDWafObject": ...
    @staticmethod
    def ddwaf_object_from_json(
        obj: "ddwaf.DDWafObject", json: bytes, length: int, alloc: "ddwaf.DDWafAllocator"
    ) -> bool: ...
    @staticmethod
    def ddwaf_object_destroy(obj: "ddwaf.DDWafObject", alloc: "ddwaf.DDWafAllocator") -> None: ...
    @staticmethod
    def ddwaf_object_get_signed(obj: "ddwaf.DDWafObject") -> int: ...
    @staticmethod
    def ddwaf_object_get_unsigned(obj: "ddwaf.DDWafObject") -> int: ...
    @staticmethod
    def ddwaf_object_get_bool(obj: "ddwaf.DDWafObject") -> bool: ...
    @staticmethod
    def ddwaf_object_get_float(obj: "ddwaf.DDWafObject") -> float: ...
    @staticmethod
    def ddwaf_object_get_bytes(obj: "ddwaf.DDWafObject") -> bytes: ...
    @staticmethod
    def ddwaf_object_array_len(obj: "ddwaf.DDWafObject") -> int: ...
    @staticmethod
    def ddwaf_object_array_get(obj: "ddwaf.DDWafObject", index: int) -> "ddwaf.DDWafObject": ...
    @staticmethod
    def ddwaf_object_map_len(obj: "ddwaf.DDWafObject") -> int: ...
    @staticmethod
    def ddwaf_object_map_key(obj: "ddwaf.DDWafObject", index: int) -> "ddwaf.DDWafObject": ...
    @staticmethod
    def ddwaf_object_map_value(obj: "ddwaf.DDWafObject", index: int) -> "ddwaf.DDWafObject": ...
    @staticmethod
    def ddwaf_builder_init() -> "ddwaf.DDWafBuilder": ...
    @staticmethod
    def ddwaf_builder_add_or_update_config(
        builder: "ddwaf.DDWafBuilder",
        path: bytes,
        path_len: int,
        config: "ddwaf.DDWafObject",
        diagnostics: "ddwaf.DDWafObject",
    ) -> bool: ...
    @staticmethod
    def ddwaf_builder_remove_config(builder: "ddwaf.DDWafBuilder", path: bytes, path_len: int) -> bool: ...
    @staticmethod
    def ddwaf_builder_build_instance(builder: "ddwaf.DDWafBuilder") -> "ddwaf.DDWafHandle": ...
    @staticmethod
    def ddwaf_builder_get_config_paths(builder: "ddwaf.DDWafBuilder", filter_re: bytes, filter_len: int) -> int: ...
    @staticmethod
    def ddwaf_known_addresses(handle: "ddwaf.DDWafHandle") -> list[str]: ...
    @staticmethod
    def ddwaf_context_init(handle: "ddwaf.DDWafHandle", alloc: "ddwaf.DDWafAllocator") -> "ddwaf.DDWafContext": ...
    @staticmethod
    def ddwaf_subcontext_init(context: "ddwaf.DDWafContext") -> "ddwaf.DDWafSubcontext": ...
    @staticmethod
    def ddwaf_context_eval(
        context: "ddwaf.DDWafContext",
        data: "ddwaf.DDWafObject",
        alloc: "ddwaf.DDWafAllocator",
        result: "ddwaf.DDWafObject",
        timeout_us: int,
    ) -> int: ...
    @staticmethod
    def ddwaf_subcontext_eval(
        subcontext: "ddwaf.DDWafSubcontext",
        data: "ddwaf.DDWafObject",
        alloc: "ddwaf.DDWafAllocator",
        result: "ddwaf.DDWafObject",
        timeout_us: int,
