...
class SpanData:
    ...
    def _set_meta_inner(self, key: SpanKey, value: SpanStr): ...
    def _delete_meta_inner(self, key: SpanKey): ...
    def _get_meta_inner(self, key: SpanKey) -> Optional[str]: ...
    def _meta_into_py_dict(self) -> Dict[SpanKey, SpanStr]: ...
    def _is_meta_empty_inner(self) -> bool: ...
    def _is_metrics_empty_inner(self) -> bool: ...
    def _set_struct_tag_inner(self, key: str, value: Dict[str, Any]): ...
    def _get_struct_tag_inner(self, key: str) -> Dict[str, Any]: ...
