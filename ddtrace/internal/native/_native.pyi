...
class SpanData:
    ...
    def _metrics_len(self) -> int: ...
    def _meta_items(self) -> list[tuple[str, str]]: ...
    def _metrics_items(self) -> list[tuple[str, float]]: ...

class StrAttributesMapping:
...
class NumericAttributesMapping:
