...
def _normalize_ai_usage(raw: Optional[dict[str, Any]]) -> tuple[dict[str, int], dict[str, float], list[str]]: ...
def _ai_usage_context_bucket(tokens: Any, reliable: bool) -> str: ...
def _ai_usage_label(value: Any, max_length: int = 256) -> Optional[str]: ...
