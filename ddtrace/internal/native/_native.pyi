...
def encode_pathway_b64(hash_value: int, pathway_start_ms: int, current_edge_start_ms: int) -> str: ...
def decode_pathway_b64(data: Union[str, bytes]) -> Optional[tuple[int, int, int]]: ...
