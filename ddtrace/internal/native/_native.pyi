...
class SpanData:
    ...
    # Attribute API — operates on native meta/metrics HashMaps
    def _set_attribute(self, key: str, value: Union[str, int, float, bytes]) -> None: ...
