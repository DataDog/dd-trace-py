...
class Config(object):
    ...
    def __init__(self) -> None:
        ...
        # NativeTraceBuffer hands buffering and flush scheduling to libdatadog instead of running
        # them from a Python periodic thread.
        self._trace_native_buffer_enabled = _get_config("_DD_TRACE_NATIVE_BUFFER_ENABLED", True, asbool)
