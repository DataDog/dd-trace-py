...
class ASMConfig(DDConfig):
    ...
    def asm_enabled_origin(self):
        if APPSEC_ENV in env.dd_environ:
    ...
    def _eval_asm_can_be_enabled(self) -> None:
        self._asm_can_be_enabled = APPSEC_ENV not in env.dd_environ and tracer_config._remote_config_enabled
        ...
        if APPSEC_ENV in env.dd_environ and self._asm_enabled:
