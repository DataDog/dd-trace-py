...
SUPPORTED_CONFIGURATIONS: frozenset[str] = frozenset(
    {
        ...
        "DD_TELEMETRY_PORT",
        "DD_TEMPORALIO_DISTRIBUTED_TRACING",
        "DD_TEMPORALIO_SERVICE",
        "DD_TESTING_RAISE",
        "DD_TEST_DEBUG",
...
CONFIGURATION_ALIASES: dict[str, list[str]] = {
    ...
    "DD_HTTPX2_SERVICE": ["DD_HTTPX2_SERVICE_NAME"],
    ...
    "DD_TEMPORALIO_SERVICE": ["DD_TEMPORALIO_SERVICE_NAME"],
