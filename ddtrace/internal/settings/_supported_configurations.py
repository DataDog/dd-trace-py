...
CONFIGURATION_ALIASES: dict[str, list[str]] = {
    ...
    "DD_TRACE_PROPAGATION_STYLE_EXTRACT": ["DD_TRACE_PROPAGATION_STYLE", "OTEL_PROPAGATORS"],
    "DD_TRACE_PROPAGATION_STYLE_INJECT": ["DD_TRACE_PROPAGATION_STYLE", "OTEL_PROPAGATORS"],
    "DD_TRACE_SAMPLING_RULES": ["OTEL_TRACES_SAMPLER"],
    ...
    "OTEL_TRACES_SAMPLER": ["DD_TRACE_SAMPLING_RULES"],
}
