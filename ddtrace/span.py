...
MetaTagKeyT = Union[Text, bytes]
MetaDictT = Dict[MetaTagKeyT, Text]
...
class Span(object):
    ...
    def get_tag(self, key):
        # type: (MetaTagKeyT) -> Optional[Text]
