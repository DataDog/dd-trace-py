...
class _PprofConverter(object):
    ...
    _functions: typing.Dict[typing.Tuple[str, typing.Optional[str]], pprof_FunctionType] = field(default_factory=dict, init=False)
    _locations: typing.Dict[typing.Tuple[str, int, str], pprof_LocationType] = field(default_factory=dict, init=False)
    _string_table: _StringTable = field(default_factory=_StringTable, init=False)

    _last_location_id: typing.Iterator[int] = field(default_factory=lambda: itertools.count(1), init=False)
    _last_func_id: typing.Iterator[int] = field(default_factory=lambda: itertools.count(1), init=False)
    ...
    _location_values: typing.DefaultDict[_Location_Key_T, typing.DefaultDict[str, int]] = field(
        init=False,
        repr=False,
