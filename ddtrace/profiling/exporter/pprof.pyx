...
class _PprofConverter:
    ...
    _functions: typing.Dict[typing.Tuple[str, typing.Optional[str]], pprof_FunctionType] = dataclasses.field(default_factory=dict, init=False)
    _locations: typing.Dict[typing.Tuple[str, int, str], pprof_LocationType] = dataclasses.field(default_factory=dict, init=False)
    _string_table: _StringTable = dataclasses.field(default_factory=_StringTable, init=False)

    _last_location_id: typing.Iterator[int] = dataclasses.field(default_factory=lambda: itertools.count(1), init=False)
    _last_func_id: typing.Iterator[int] = dataclasses.field(default_factory=lambda: itertools.count(1), init=False)
    ...
    _location_values: typing.DefaultDict[_Location_Key_T, typing.DefaultDict[str, int]] = dataclasses.field(
        init=False,
        repr=False,
        default_factory=lambda: collections.defaultdict(lambda: collections.defaultdict(lambda: 0))
    )
    ...
    __annotations__ = {
        ...
        "_last_location_id": typing.Iterator[int],
        "_last_func_id": typing.Iterator[int],
