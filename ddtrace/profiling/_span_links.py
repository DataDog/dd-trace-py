...
class SpanLinkDomain(enum.IntEnum):
    # Keep this module importable when the optional native stack extension is unavailable.
    ASYNCIO_TASK = getattr(stack, "SPAN_LINK_DOMAIN_ASYNCIO_TASK", 1)
    GEVENT_GREENLET = getattr(stack, "SPAN_LINK_DOMAIN_GEVENT_GREENLET", 2)
