...
class Profiler(object):
    ...
    def _start_with_active_lock(self, register_on_exit_signal: bool = True) -> None:
        ...
        try:
            ...
            # AIDEV-NOTE: A failed start must not leave the profiler running or holding process ownership.
    ...
    def _start_profiler_with_active_lock(self) -> None:
        was_stopped = self._profiler.status == service.ServiceStatus.STOPPED
        try:
