...
try:
    from ddtrace.profiling.collector._sampler import CaptureSampler  # pyright: ignore[reportAssignmentType]
except ImportError:

    class CaptureSampler:  # type: ignore[no-redef]
        """Pure-Python fallback for ``DD_CYTHONIZE=0`` builds."""
