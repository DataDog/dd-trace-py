...
class MemoryCollector:
    ...
    def __init__(
        ...
        self.code_cache_size = cast(
            int,
            code_cache_size if code_cache_size is not None else config.memalloc.code_cache_size,  # pyright: ignore
        )
    ...
    def start(self) -> None:
        ...
        try:
            _memalloc.start(self.max_nframe, self.heap_sample_size, self.mem_domain_enabled, self.code_cache_size)
        except RuntimeError:
