...
class DebuggerConfig(object):
    ...
    probe_url = tracer_config.trace_agent_url
    snapshot_intake_url = tracer_config.trace_agent_url
    ...
    def __init__(self):
        ...
        try:
            ...
            self.snapshot_intake_url = tracer_config.trace_agent_url
            self._snapshot_intake_endpoint = "/debugger" + self._snapshot_intake_endpoint

        self.probe_url = os.getenv("DD_DEBUGGER_PROBE_URL", tracer_config.trace_agent_url)
