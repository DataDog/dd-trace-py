...
#
# LLM and embedding builders return (request_kwargs, model) since the model
# is needed for event creation.  Non-model builders (query, retrieval, agent)
# return just request_kwargs.
# ---------------------------------------------------------------------------
