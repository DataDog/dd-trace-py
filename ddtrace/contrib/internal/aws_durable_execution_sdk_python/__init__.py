...
- ``aws_lambda.durable_function.execution_name``: The Lambda function name extracted from the execution ARN.
- ``aws_lambda.durable_function.execution_id``: The execution ID extracted from the execution ARN.
