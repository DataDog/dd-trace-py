...
# OpenTelemetry HTTP semantic conventions. Obfuscation and redaction stay shared with the
# Datadog path above, so only attribute names move, never what a value contains.
