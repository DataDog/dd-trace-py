...
config._add(
    "botocore",
    {
        ...
        "payload_tagging_max_tags": int(os.getenv("DD_TRACE_CLOUD_PAYLOAD_TAGGING_MAX_TAGS", 758)),
        "payload_tagging_services": set(os.getenv("DD_TRACE_CLOUD_PAYLOAD_TAGGING_SERVICES", default="s3,sns,sqs,kinesis,eventbridge").split(",")),
    },
)
