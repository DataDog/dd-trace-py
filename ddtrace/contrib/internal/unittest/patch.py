...
def _update_skipped_elements_and_set_tags(test_module_span: ddtrace.trace.Span, test_session_span: ddtrace.trace.Span):
    ...
    current = test_module_span._get_numeric_attribute(test.ITR_TEST_SKIPPING_COUNT) or 0
    test_module_span._set_attribute(test.ITR_TEST_SKIPPING_COUNT, current + 1)
