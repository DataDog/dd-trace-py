...
config._add(
    ...
    dict(
        ...
        operation_name=_get_env("DD_UNITTEST_OPERATION_NAME", default="unittest.test"),
        strict_naming=asbool(_get_env("DD_CIVISIBILITY_UNITTEST_STRICT_NAMING", default=True)),
    ),
)
