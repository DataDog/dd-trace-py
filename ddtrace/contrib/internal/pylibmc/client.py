    ...
    def _trace_cmd(self, method_name, *args, **kwargs):
        ...
        with self._span(method_name) as span:
            ...
            if method_name == "get":
                ...
                span._set_attribute(db.ROWCOUNT, 1 if isinstance(result, Iterable) and len(result) > 0 and result[0] else 0)
            return result
    ...
    def _trace_multi_cmd(self, method_name, *args, **kwargs):
        ...
        with self._span(method_name) as span:
            ...
            if method_name == "get_multi":
                ...
                span._set_attribute(db.ROWCOUNT, sum(1 for doc in result if doc) if result and isinstance(result, Iterable) else 0)
            return result
