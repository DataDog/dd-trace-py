...
config._add(
    "openai",
    {
        "span_prompt_completion_sample_rate": float(_env.getenv("DD_OPENAI_SPAN_PROMPT_COMPLETION_SAMPLE_RATE", 1.0)),
        "span_char_limit": int(_env.getenv("DD_OPENAI_SPAN_CHAR_LIMIT", 128)),
    },
)
