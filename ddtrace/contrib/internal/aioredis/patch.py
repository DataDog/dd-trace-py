...
config._add(
    ...
    dict(
        ...
        cmd_max_length=int(os.getenv("DD_AIOREDIS_CMD_MAX_LENGTH", CMD_MAX_LEN)),  # noqa: DDC001
        resource_only_command=asbool(os.getenv("DD_REDIS_RESOURCE_ONLY_COMMAND", True)),  # noqa: DDC001
    ),
)
