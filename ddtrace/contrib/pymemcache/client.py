...
class WrappedPooledClient(wrapt.ObjectProxy):
    def __init__(self, *args, **kwargs):
        c = _PooledClient(*args, **kwargs)
        super(WrappedPooledClient, self).__init__(c)
...
class WrappedHashClient(wrapt.ObjectProxy):
    def __init__(self, *args, **kwargs):
        c = _HashClient(*args, **kwargs)
        super(WrappedHashClient, self).__init__(c)
    ...
    def _traced_cmd(self, cmd, key, default_val, *args, **kwargs):
        ...
        with self._trace(p, cmd, *args, **kwargs):
            result = self._safely_run_func(client, func, default_val, *args, **kwargs)
            return result

    @contextlib.contextmanager
    def _trace(self, p, method_name, *args, **kwargs):
        with p.tracer.trace(
            schematize_cache_operation(memcachedx.CMD, cache_provider="memcached"),
            service=p.service,
            resource=method_name,
