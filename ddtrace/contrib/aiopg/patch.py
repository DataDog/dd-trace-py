...
from ddtrace.contrib.psycopg2.patch import _patch_extensions
from ddtrace.contrib.psycopg2.patch import _unpatch_extensions
from ddtrace.contrib.psycopg2.patch import patch_conn as psycopg_patch_conn
