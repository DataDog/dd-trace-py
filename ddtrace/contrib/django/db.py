...
class TracedCursor(object):
    ...
    def _trace(self, func, sql, params):
        ...
        with span:
            # The sql query MUST NOT be added as a tag as is added by the agent in the tag `sql.query`.
            # See: https://github.com/DataDog/datadog-trace-agent/blob/bda1ebbf170dd8c5879be993bdd4dbae70d10fda/obfuscate/sql.go#L232
