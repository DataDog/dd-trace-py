...
deprecate(
    "The aioredis integration is deprecated and will be removed in a future version",
    message="Please use the 'redis' library integration with redis>=4.2.0 instead.",
