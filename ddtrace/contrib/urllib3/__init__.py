...
from ddtrace.contrib.internal.urllib3.patch import get_version  # noqa: F401
from ddtrace.contrib.internal.urllib3.patch import patch  # noqa: F401
from ddtrace.contrib.internal.urllib3.patch import unpatch  # noqa: F401
...
deprecate(
    ...
    "Set DD_TRACE_URLLIB3_ENABLED=true and use ``import ddtrace.auto`` or the "
