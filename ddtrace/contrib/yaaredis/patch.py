...
def patch():
    ...
    _w("yaaredis.client", "StrictRedis.execute_command", _traced_execute_command)
    _w("yaaredis.client", "StrictRedis.pipeline", _traced_pipeline)
    _w("yaaredis.pipeline", "StrictPipeline.execute", _traced_execute_pipeline)
    _w("yaaredis.pipeline", "StrictPipeline.immediate_execute_command", _traced_execute_command)
