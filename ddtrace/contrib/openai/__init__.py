...
.. py:data:: ddtrace.config.openai["logs_enabled"]
   ...
   - ``DD_OPENAI_LOGS_ENABLED``, which takes precedence over ``DD_LLMOBS_LOGS_ENABLED``. 
...
.. py:data:: ddtrace.config.openai["metrics_enabled"]
   ...
   - ``DD_OPENAI_METRICS_ENABLED``, which takes precedence over ``DD_LLMOBS_METRICS_ENABLED``. 
