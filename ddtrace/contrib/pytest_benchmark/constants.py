...
PLUGIN_METRICS = {BENCHMARK_MEAN: PLUGIN_MEAN, BENCHMARK_RUN: PLUGIN_ROUNDS, STATISTICS_HD15IQR: PLUGIN_HD15IQR,
                  STATISTICS_IQR: PLUGIN_IQR, STATISTICS_IQR_OUTLIERS: PLUGIN_IQR_OUTLIERS,
                  STATISTICS_LD15IQR: PLUGIN_LD15IQR, STATISTICS_MAX: PLUGIN_MAX, STATISTICS_MEAN: PLUGIN_MEAN,
                  STATISTICS_MEDIAN: PLUGIN_MEDIAN, STATISTICS_MIN: PLUGIN_MIN, STATISTICS_OPS: PLUGIN_OPS,
                  STATISTICS_OUTLIERS: PLUGIN_OUTLIERS, STATISTICS_Q1: PLUGIN_Q1, STATISTICS_Q3: PLUGIN_Q3,
                  STATISTICS_N: PLUGIN_ROUNDS, STATISTICS_STDDEV: PLUGIN_STDDEV,
                  STATISTICS_STDDEV_OUTLIERS: PLUGIN_STDDEV_OUTLIERS, STATISTICS_TOTAL: PLUGIN_TOTAL}
