...
PLUGIN_METRICS = {BENCHMARK_MEAN: PLUGIN_MEAN, BENCHMARK_RUN: PLUGIN_ROUNDS, STATISTICS_HD15IQR: PLUGIN_HD15IQR,
                  ...
                  STATISTICS_MIN: PLUGIN_MIN, STATISTICS_OPS: PLUGIN_OPS, STATISTICS_Q1: PLUGIN_Q1,
                  STATISTICS_Q3: PLUGIN_Q3, STATISTICS_N: PLUGIN_ROUNDS, STATISTICS_STDDEV: PLUGIN_STDDEV,
