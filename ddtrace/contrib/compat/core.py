"""
Compatibility layer for core API that works with both Datadog and OpenTelemetry instrumentation.

When EXPERIMENTAL_OTEL_DD_INSTRUMENTATION_ENABLED is False (default), this uses the standard ddtrace.internal.core.
When True, this provides a subset of core functionality compatible with OpenTelemetry.
"""
