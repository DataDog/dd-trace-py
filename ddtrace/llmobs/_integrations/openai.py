...
class OpenAIIntegration(BaseLLMIntegration):
    ...
    def _llmobs_set_meta_tags_from_completion(
        ...
        if streamed_completions:
            ...
            span.set_tag_str(OUTPUT_MESSAGES, json.dumps(messages, skipkeys=True, default=_unserializable_default_repr))
            return
    ...
    def _llmobs_set_meta_tags_from_embedding(resp: Any, err: Any, kwargs: Dict[str, Any], span: Span) -> None:
        ...
        span.set_tag_str(
            INPUT_DOCUMENTS, json.dumps(input_documents, skipkeys=True, default=_unserializable_default_repr)
        )
