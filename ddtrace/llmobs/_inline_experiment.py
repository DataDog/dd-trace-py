...
This is the foundation layer for the "unit test for LLM apps" paradigm (RFC-002): a developer
marks an input->output boundary inline in their already-instrumented app, and the explicit,
