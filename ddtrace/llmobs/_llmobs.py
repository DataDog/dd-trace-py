...
class LLMObs(Service):
    ...
    def experiment(
        ...
        Supports both sync and async tasks, and both sync and async evaluators.
        Use exp.run() for synchronous execution or await exp.arun() for async execution.

        :param name: The name of the experiment.
        :param task: The task function to run (sync or async). Must accept parameters ``input_data`` and ``config``.
