...
class LLMObs(Service):
    ...
    def experiment(
        ...
        name: str,
        task: Union[
            Callable[[DatasetRecordInputType, Optional[ExperimentConfigType]], JSONType],
            Callable[[DatasetRecordInputType, Optional[ExperimentConfigType]], Awaitable[JSONType]],
        ],
        dataset: Dataset,
        evaluators: List[
            Union[
