...
class LLMObs(Service):
    ...
    def export_span(cls, span: Optional[Span] = None) -> Optional[ExportedLLMObsSpan]:
        ...
        try:
            ...
            from ddtrace.internal.constants import SPAN_API_OTEL as _SPAN_API_OTEL

            return ExportedLLMObsSpan(
                span_id=str(span.span_id),
                trace_id=get_llmobs_trace_id(span) or format_trace_id(span.trace_id),
                is_otel=getattr(span, "_span_api", None) == _SPAN_API_OTEL,
            )
    ...
    def submit_evaluation(
        ...
        :param ExportedLLMObsSpan span: A dictionary identifying the span for this evaluation.
                            Use ``LLMObs.export_span()`` to generate this value — it automatically
                            sets ``is_otel`` based on how the span was created. If constructing
                            manually, set ``is_otel=True`` when the span was generated by OTel
                            gen.ai instrumentation (OTel semantic conventions), or ``is_otel=False``
                            for spans generated by ddtrace tracing apis.
        ...
        try:
            ...
            if span is not None and span.get("is_otel"):
