...
class ExportedLLMObsSpan(TypedDict):
    ...
    automatically. When constructing manually, set ``is_otel=True`` if the span was
    generated by OTel gen.ai instrumentation (OTel semantic conventions), or
    ``is_otel=False`` if generated by the Datadog LLMObs API.
    """
