...
class BaseEvaluator(ABC):
    ...
    **Return Value Guidelines:**
    ...
    async def evaluate_async(self, context: EvaluatorContext) -> Union[JSONType, "EvaluatorResult"]:
    ...
    def __call__(
        self, input_data: Dict[str, Any], output_data: Any, expected_output: Any
        ...
        :return: The evaluation results (JSONType or EvaluatorResult)
        """
