...
class LLMJudge(BaseEvaluator):
    ...
    def _evaluate_traced(
        ...
        # `evaluation()` needs LLMObs enabled and an evaluated span to anchor the judge trace to.
        # Without either there is no judge trace to emit, so run untraced rather than raise.
