...
def _ddtrace_context() -> t.Generator[DDTraceTestContext, None, None]:
    ...
    with ddtrace.tracer.trace(DDTESTOPT_ROOT_SPAN_RESOURCE) as root_span:
        root_span.set_tag("type", "test")  # Selenium integration checks the span type.  # ast-grep-ignore: span-set-tag
        root_span.set_tag("span.kind", "test")  # ast-grep-ignore: span-set-tag
