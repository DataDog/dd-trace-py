...
class SessionManager:
    def __init__(self, session: TestSession) -> None:
        ...
        def _upload_git_and_fetch_skippable() -> tuple[
            set[t.Union[SuiteRef, TestRef]], t.Optional[str], dict[str, "CoverageLines"]
        ]:
        ...
        with ThreadPoolExecutor(max_workers=3) as executor:
            ...
            self.skippable_items, self.itr_correlation_id, self.itr_covered_files = skippable_future.result()
