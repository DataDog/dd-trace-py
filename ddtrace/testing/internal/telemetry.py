...
class _TestLike(t.Protocol):
    ...
    def set_location(self, path: t.Any, start_line: int) -> None: ...
    ...
    def make_test_run(self) -> _TestRunLike: ...

    @property
    def last_test_run(self) -> _TestRunLike: ...
...
class _TestRunLike(t.Protocol):
    ...
    def set_final_status(self, final_status: t.Any) -> None: ...
