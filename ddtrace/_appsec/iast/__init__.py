...
`ddtrace._appsec/iast/_patch_modules.py`

Create new file with the same name: `ddtrace._appsec/iast/taint_sinks/[my_new_vulnerability].py`
...
wrapped functions. We should create a class that inherit from `ddtrace._appsec.iast.taint_sinks._base.VulnerabilityBase`
and register with `ddtrace._appsec.iast.oce`.
...
from ddtrace._appsec.iast._overhead_control_engine import OverheadControl
