...
from ddtrace._appsec.iast._metrics import _set_metric_iast_executed_sink
from ddtrace._appsec.iast._overhead_control_engine import Operation
from ddtrace._appsec.iast._utils import _has_to_scrub
from ddtrace._appsec.iast._utils import _is_evidence_value_parts
from ddtrace._appsec.iast._utils import _scrub
...
try:
    # Python >= 3.4
    from ddtrace._appsec.iast._stacktrace import get_info_frame
except ImportError:
    # Python 2
    from ddtrace._appsec.iast._stacktrace_py2 import get_info_frame
