...
from ddtrace._appsec.iast._metrics import _set_metric_iast_instrumented_propagation
...
class AstVisitor(ast.NodeTransformer):
    def __init__(
        ...
        self._aspects_spec = {
            "definitions_module": "ddtrace._appsec.iast._taint_tracking.aspects",
        ...
        self._sinkpoints_spec = {
            "definitions_module": "ddtrace._appsec.iast.taint_sinks",
