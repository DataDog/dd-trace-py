...
from ddtrace._appsec import handlers
from ddtrace._appsec._constants import SPAN_DATA_NAMES
from ddtrace._appsec._constants import WAF_CONTEXT_NAMES
...
def set_body_response(body_response):
    ...
    from ddtrace._appsec.utils import parse_response_body
...
def _on_set_request_tags(request, span, flask_config):
    if _is_iast_enabled():
        from ddtrace._appsec.iast._metrics import _set_metric_iast_instrumented_source
        from ddtrace._appsec.iast._taint_tracking import OriginType
        from ddtrace._appsec.iast._taint_utils import LazyTaintDict
