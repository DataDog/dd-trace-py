...
class Pin(object):
    ...
    def override(
        ...
        if pin is None:
            Pin(service=service, tags=tags, tracer=tracer)._onto(obj)
        else:
            pin._clone(service=service, tags=tags, tracer=tracer)._onto(obj)
    ...
    def onto(self, obj, send=True):
        deprecate(
            "The `pin.onto` method is deprecated and will be removed.",
            message="""The `pin.onto` method is deprecated and will be removed.""",
            category=DDTraceDeprecationWarning,
        )
        return self._onto(obj, send)

    def _remove_from(self, obj):
        # type: (Any) -> None
    ...
    def remove_from(self, obj):
        deprecate(
            "The `pin.remove_from` method is deprecated and will be removed.",
            message="""The `pin.remove_from` method is deprecated and will be removed.""",
            category=DDTraceDeprecationWarning,
        )
        return self._remove_from(obj)
    ...
    def clone(
        ...
        deprecate(
            "The `pin.clone` method is deprecated and will be removed.",
            message="""The `pin.clone` method is deprecated and will be removed.""",
            category=DDTraceDeprecationWarning,
        )
        return self._clone(service=service, tags=tags, tracer=tracer)
