...
class Tracer(object):
    ...
    def _child_after_fork(self):
        ...
        # added GC tracking (`Py_TPFLAGS_HAVE_GC`) to PeriodicThread (first shipped
        # in 4.9.1), making the `NativeWriter -> _worker._target (bound method) ->
        # NativeWriter` cycle visible and collectable by the GC.
        #
