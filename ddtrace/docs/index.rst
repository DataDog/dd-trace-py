...
| :ref:`asyncio`                                   | \*            | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`asyncpg`                                   | >= 0.23.0     | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`avro`                                      | \*            | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`aws_durable_execution_sdk_python`          | >= 1.4.0      | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`azure_functions`                           | >= 1.10.1     | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`azure_durable_functions`                   | >= 1.2.1      | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`botocore`                                  | \*            | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`bottle`                                    | >= 0.12       | No             |
...
+--------------------------------------------------+---------------+----------------+
| :ref:`dramatiq`                                  | >= 1.10.0     | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`elasticsearch`                             | >= 1.1.0      | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`falcon`                                    | >= 3.0        | Yes            |
+--------------------------------------------------+---------------+----------------+
...
| :ref:`futures`                                   | \*            | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`gevent` (greenlet>=1.0)                    | >= 21.1.2     | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`google_adk`                                | >= 1.0.0      | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`google_genai`                              | >= 1.21.1     | Yes            |
+--------------------------------------------------+---------------+----------------+
| :ref:`google_cloud_pubsub`                       | >= 2.10.0     | Yes            |
+--------------------------------------------------+---------------+----------------+
