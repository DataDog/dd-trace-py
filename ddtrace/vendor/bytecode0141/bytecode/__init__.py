...
from ddtrace.vendor.bytecode0141.bytecode.bytecode import (  # noqa
    BaseBytecode,
    Bytecode,
    _BaseBytecodeList,
    _InstrList,
...
# import needed to use it in bytecode.py
from ddtrace.vendor.bytecode0141.bytecode.cfg import BasicBlock, ControlFlowGraph  # noqa

# import needed to use it in bytecode.py
from ddtrace.vendor.bytecode0141.bytecode.concrete import _ConvertBytecodeToConcrete  # noqa
from ddtrace.vendor.bytecode0141.bytecode.concrete import ConcreteBytecode, ConcreteInstr
from ddtrace.vendor.bytecode0141.bytecode.flags import CompilerFlags

# import needed to use it in bytecode.py
from ddtrace.vendor.bytecode0141.bytecode.instr import (  # noqa
    UNSET,
    BinaryOp,
    CellVar,
    Compare,
...
from ddtrace.vendor.bytecode0141.bytecode.version import __version__
