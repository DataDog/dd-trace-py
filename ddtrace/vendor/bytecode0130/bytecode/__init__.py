...
from ddtrace.vendor.bytecode0130.bytecode.flags import CompilerFlags
from ddtrace.vendor.bytecode0130.bytecode.instr import (
    UNSET,
    Label,
    SetLineno,
    Instr,
...
from ddtrace.vendor.bytecode0130.bytecode.bytecode import (
    BaseBytecode,
    _BaseBytecodeList,
    _InstrList,
    Bytecode,
)  # noqa
from ddtrace.vendor.bytecode0130.bytecode.concrete import (
    ConcreteInstr,
    ConcreteBytecode,  # noqa
    # import needed to use it in bytecode.py
    _ConvertBytecodeToConcrete,
)
from ddtrace.vendor.bytecode0130.bytecode.cfg import BasicBlock, ControlFlowGraph  # noqa
