...
from ._inferred_service import detect_service
...
class Config(object):
    ...
    def __init__(self):
        ...
        self._inferred_service = detect_service(sys.argv)
        ...
        if self.service is None and self._inferred_service:
            self.service = self._inferred_service
