...
def config_str(config):
    ...
    if config.stack.enabled:
        if config.stack.v2_enabled:
            ...
            configured_features.append("v2_mode_" + config.stack.v2_mode)
        else:
