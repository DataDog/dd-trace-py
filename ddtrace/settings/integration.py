...
class IntegrationConfig(AttrDict):
    ...
    def __init__(self, global_config, name, *args, **kwargs):
        ...
        service = os.getenv("DD_" + name + "_" + "SERVICE", os.getenv("DD_" + name + "_" + "SERVICE_NAME", default=None))
    ...
    def _get_analytics_settings(self):
        ...
        _ = os.environ.get("DD_TRACE_%s_ANALYTICS_ENABLED" % self.integration_name.upper())
