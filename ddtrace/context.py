...
from .internal.utils.http import w3c_format_known_propagated_tags as _w3c_format_known_propagated_tags
from .internal.utils.http import w3c_format_unknown_propagated_tags as _w3c_format_unknown_propagated_tags
