#!/usr/bin/env bash
# Build a Windows wheel for ddtrace-internal using the pre-configured Docker image.
...
PROJECT_DIR_WIN=$(cygpath -w "${PROJECT_DIR}/ddtrace-internal")
...
rm -rf "${PROJECT_DIR}/ddtrace-internal/dist"
