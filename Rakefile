...
task:ci_test do
  ...
  begin
    ...
    when 0
      sh "tox -e flake8,wait,py27-tracer,py34-tracer,py27-integration,py34-integration,py27-contrib,py34-contrib,py27-bottle12-webtest,py34-bottle12-webtest,py27-cassandra35,py27-cassandra36,py27-cassandra37,py34-cassandra35,py34-cassandra36,py34-cassandra37"
    when 1
      sh "tox -e wait,py27-elasticsearch23,py34-elasticsearch23,py27-falcon10,py34-falcon10,py27-django18-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py27-django19-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py27-django110-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py34-django18-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py34-django19-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py34-django110-djangopylibmc06-djangoredis45-pylibmc-redis-memcached,py27-flask010-blinker,py27-flask011-blinker,py34-flask010-blinker,py34-flask011-blinker"
      sh "tox -e py27-flask010-flaskcache012-memcached-redis-blinker,py27-flask011-flaskcache012-memcached-redis-blinker,py27-mysqlconnector21,py34-mysqlconnector21,py27-pylibmc140,py27-pylibmc150,py34-pylibmc140,py34-pylibmc150,py27-pymongo30-mongoengine,py27-pymongo31-mongoengine,py27-pymongo32-mongoengine,py27-pymongo33-mongoengine,py34-pymongo30-mongoengine,py34-pymongo31-mongoengine,py34-pymongo32-mongoengine,py34-pymongo33-mongoengine,py27-pyramid17-webtest,py27-pyramid18-webtest,py34-pyramid17-webtest,py34-pyramid18-webtest"
    when 2
      sh "tox -e wait,py27-flask010-flaskcache013-memcached-redis-blinker,py27-flask011-flaskcache013-memcached-redis-blinker,py34-flask010-flaskcache013-memcached-redis-blinker,py34-flask011-flaskcache013-memcached-redis-blinker,py27-gevent10,py27-gevent11,py34-gevent10,py34-gevent11"
      sh "tox -e py27-requests208,py27-requests209,py27-requests210,py27-requests211,py34-requests208,py34-requests209,py34-requests210,py34-requests211,py27-sqlalchemy10-psycopg2,py27-sqlalchemy11-psycopg2,py34-sqlalchemy10-psycopg2,py34-sqlalchemy11-psycopg2,py27-redis,py34-redis,py27-sqlite3,py34-sqlite3"
    else
