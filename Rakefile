...
task:ci_test do
  ...
  begin
    ...
    when 2
      sh "detox -e wait,py27-flask010-flaskcache013-memcached-redis-blinker,py27-flask011-flaskcache013-memcached-redis-blinker,py34-flask010-flaskcache013-memcached-redis-blinker,py34-flask011-flaskcache013-memcached-redis-blinker,py27-gevent10,py27-gevent11,py34-gevent10,py34-gevent11"
      sh "detox -e py27-requests208,py27-requests209,py27-requests210,py27-requests211,py34-requests208,py34-requests209,py34-requests210,py34-requests211,py27-sqlalchemy10-psycopg2,py27-sqlalchemy11-psycopg2,py34-sqlalchemy10-psycopg2,py34-sqlalchemy11-psycopg2,py27-redis,py34-redis,py27-sqlite3,py34-sqlite3"
    else
