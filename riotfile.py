...
venv = Venv(
    ...
    venvs=[
        ...
        Venv(
            ...
            # Enabling coverage for integration tests breaks certain tests in CI
            # Also, running two separate pytest sessions, the ``civisibility`` one with --no-ddtrace
            command="pytest -n 8 --dist=loadscope --no-cov --no-ddtrace {cmdargs} tests/integration/test_integration_civisibility.py",
        ...
        Venv(
            name="datastreams",
            command="pytest -n 8 --dist=loadscope --no-cov {cmdargs} tests/datastreams/",
            pkgs={
                "msgpack": [latest],
                "pytest-xdist": latest,
            },
        ...
        Venv(
            name="runtime",
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/runtime/",
            venvs=[
                Venv(
                    pys=select_pys(),
                    pkgs={
        ...
        Venv(
            name="vendor",
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/vendor/",
            pys=select_pys(),
            pkgs={
        ...
        Venv(
            name="vertica",
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/contrib/vertica/",
        ...
        Venv(
            ...
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/contrib/djangorestframework",
            pkgs={
                "pytest-django[testing]": "==3.10.0",
                "pytest-xdist": latest,
            },
        ...
        Venv(
            name="pynamodb",
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/contrib/pynamodb",
        ...
        Venv(
            name="logbook",
            pys=select_pys(),
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/contrib/logbook",
            pkgs={
        ...
        Venv(
            name="molten",
            command="pytest -n 8 --dist=loadscope {cmdargs} tests/contrib/molten",
            pys=select_pys(),
            pkgs={
                "cattrs": ["<23.1.1"],
