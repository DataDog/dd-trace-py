...
venv = Venv(
    ...
    venvs=[
        ...
        Venv(
            ...
            # Enabling coverage for integration tests breaks certain tests in CI
            # Also, running two separate pytest sessions, the ``civisibility`` one with --no-ddtrace
            command="pytest -n 8 --no-cov --no-ddtrace {cmdargs} tests/integration/test_integration_civisibility.py",
        ...
        Venv(
            name="datastreams",
            command="pytest -n 8 --no-cov {cmdargs} tests/datastreams/",
            pkgs={
                "msgpack": [latest],
                "pytest-xdist": latest,
            },
        ...
        Venv(
            name="runtime",
            command="pytest -n 8 {cmdargs} tests/runtime/",
            venvs=[
                Venv(
                    pys=select_pys(),
                    pkgs={
        ...
        Venv(
            name="vendor",
            command="pytest -n 8 {cmdargs} tests/vendor/",
            pys=select_pys(),
            pkgs={
        ...
        Venv(
            name="vertica",
            command="pytest -n 8 {cmdargs} tests/contrib/vertica/",
