...
if PY_Latest:
    ...
    def latest(arg: str):
        return ("==" + arg) if arg else riot_latest
...
venv = Venv(
    pkgs={
        "mock": latest("4.0.3"),
        "pytest": "<7.0.0",
        "pytest-mock": latest("3.10.0"),
        "coverage": latest("6.5.0"),
        "pytest-cov": latest("4.0.0"),
        "opentracing": latest(""),
        "hypothesis": "<6.45.1",
    },
    env={
    ...
    venvs=[
        ...
        Venv(
            ...
            pkgs={
                ...
                "daphne": "<=4.0.0",  # Python >= 3.7 supported
                "requests": "<=2.28.1",
                "redis": ">=2.10,<2.11",
        ...
        Venv(
            ...
            venvs=[
                ...
                Venv(
                    ...
                    pkgs={
                        "django": ">=2.2,<2.3",
                        "djangorestframework": [">=3.8,<3.9", ">=3.9,<3.10", "~=3.12"],
                        "pytest-django": "==3.10.0",
                    },
                ),
                Venv(
                ...
                Venv(
                    ...
                    pkgs={
                        "django": "~=4.0",
                        "djangorestframework": ["~=3.13", "~=3.14.0"],
                        "pytest-django": "==3.10.0",
                    },
                ),
            ],
        ...
        Venv(
            ...
            venvs=[
                Venv(
                    ...
                    pkgs={"pytest": ">=4.0,<4.6", "msgpack": "<=1.0.4"},
                ),
                Venv(
                    pys=select_pys(min_version="3.5", max_version="3.9"),
                    pkgs={
...
def latest_version(packages):
    ...
    return {p: get(p) for p in packages}
