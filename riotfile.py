...
venv = Venv(
    ...
    venvs=[
        ...
        Venv(
            ...
            command="python -m tests.profiling.run pytest -v --no-cov --capture=no --benchmark-disable --ignore='tests/profiling/collector/test_memalloc.py' --ignore='tests/profiling/test_memalloc_fork.py' --count 100 {cmdargs} tests/profiling/collector/test_exception.py -k 'test_generatorexit_not_sampled or test_raise_fires_once_per_exception'",  # noqa: E501
            env={
