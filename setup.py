...
if not IS_PYSTON:
    ...
    if platform.system() not in ("Windows", ""):
        ...
        ext_modules.append(CMakeExtension("ddtrace.appsec._iast._taint_tracking._native", source_dir=IAST_DIR, optional=False))
...
setup(
    ...
    package_data={
        ...
        "ddtrace.appseciast._taint_tracking": ["CMakeLists.txt"],
