...
class CustomBuildRust(build_rust):
    ...
    def run(self):
        ...
        # Set CARGO_TARGET_DIR to ensure headers are generated in the right place
        env = os.environ.copy()
        target_dir = NATIVE_CRATE.absolute() / "target"
        env["CARGO_TARGET_DIR"] = str(target_dir)

        # Set environment variables for the build
        # this is necessary to install headers generated by cbindings
        ...
        if hasattr(self, "native_features") and self.native_features and "profiling" in self.native_features:
            ...
            include_dir = target_dir / "include" / "datadog"
...
class CustomBuildExt(build_ext):
    ...
    def build_rust(self):
        ...
        build_rust_cmd.native_features = native_features  # Pass the features to the command
